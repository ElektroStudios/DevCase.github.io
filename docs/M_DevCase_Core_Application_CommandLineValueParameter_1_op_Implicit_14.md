# CommandLineValueParameter(*T*)&nbsp;Implicit Conversion (CommandLineValueParameter(UInt32) to CommandLineValueParameter(*T*))
...
#### Parameters
&nbsp;<dl><dt>cmd</dt><dd>Type: <a href="T_DevCase_Core_Application_CommandLineValueParameter_1">DevCase.Core.Application.CommandLineValueParameter</a>(UInt32)<br />The <a href="T_DevCase_Core_Application_CommandLineValueParameter_1">CommandLineValueParameter(T)</a> to convert.</dd></dl>

# ScreenExtensions Methods
 

The <a href="T_DevCase_Core_Extensions_Screen_ScreenExtensions">ScreenExtensions</a> type exposes the following members.
...
<a href="#screenextensions-methods">Back to Top</a>

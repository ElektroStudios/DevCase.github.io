# EnvironmentFolders.ApplicationDataPath Property 
...
**VB**<br />
``` VB
Public Shared ReadOnly Property ApplicationDataPath ( 
...
value = EnvironmentFolders.ApplicationDataPath(folderOption)
...
``` C++
public:
static property String^ ApplicationDataPath[Environment.SpecialFolderOption folderOption = Environment.SpecialFolderOption::None] {
...
#### Property Value
Type: String<br />\[Missing <value> documentation for "P:DevCase.Core.Shell.EnvironmentFolders.ApplicationDataPath(System.Environment.SpecialFolderOption)"\]

## Examples
This is a code example. 
**VB**<br />
``` VB
Console.WriteLine($"{NameOf(EnvironmentFolders.ApplicationDataPath)}={EnvironmentFolders.ApplicationDataPath}")
```

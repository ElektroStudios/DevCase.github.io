# UnwrappedCollectionEditor(*T*) Methods
 

The <a href="T_DevCase_Core_Design_UnwrappedCollectionEditor_1">UnwrappedCollectionEditor(T)</a> generic type exposes the following members.
...
<a href="#unwrappedcollectioneditor(*t*)-methods">Back to Top</a>

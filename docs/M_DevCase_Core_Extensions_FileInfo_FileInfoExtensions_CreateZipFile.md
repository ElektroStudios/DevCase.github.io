# FileInfoExtensions.CreateZipFile Method (FileInfo)
 

Creates a zip archive from the specified file, using the source filename to create the zip file, with Optimal compression level.
...
returnValue = file.CreateZipFile()
```
...
static member CreateZipFile : 
        file : FileInfo -> ZipArchive 

```


#### Parameters
&nbsp;<dl><dt>file</dt><dd>Type: System.IO.FileInfo<br />The source FileInfo.</dd></dl>

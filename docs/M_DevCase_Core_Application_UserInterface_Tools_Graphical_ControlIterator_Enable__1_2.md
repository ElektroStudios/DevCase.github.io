# ControlIterator.Enable(*T*) Method (Control.ControlCollection, String)
...
**VB**<br />
``` VB
Public Shared Function Enable(Of T As Control) ( 
...
returnValue = ControlIterator.Enable(controlCollection, 
	containsName)
```

...
A extended CheckBox control.


## Inheritance Hierarchy
System.Object<br />&nbsp;&nbsp;System.MarshalByRefObject<br />&nbsp;&nbsp;&nbsp;&nbsp;System.ComponentModel.Component<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;System.Windows.Forms.Control<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;System.Windows.Forms.ButtonBase<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;System.Windows.Forms.CheckBox<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;DevCase.Controls.DevCheckBox<br />
...
public class DevCheckBox : CheckBox
```

**VB**<br />
``` VB
<ToolboxBitmapAttribute(GetType(CheckBox), "CheckBox.bmp")>
<ClassInterfaceAttribute(ClassInterfaceType.AutoDispatch)>
<ComVisibleAttribute(true)>
<DefaultBindingPropertyAttribute("CheckState")>
<DefaultPropertyAttribute("Checked")>
<DefaultEventAttribute("CheckedChanged")>
Public Class DevCheckBox
	Inherits CheckBox
```
...
**C++**<br />
``` C++
[ToolboxBitmapAttribute(typeof(CheckBox), L"CheckBox.bmp")]
[ClassInterfaceAttribute(ClassInterfaceType::AutoDispatch)]
[ComVisibleAttribute(true)]
[DefaultBindingPropertyAttribute(L"CheckState")]
[DefaultPropertyAttribute(L"Checked")]
[DefaultEventAttribute(L"CheckedChanged")]
public ref class DevCheckBox : public CheckBox
```
...
The DevCheckBox type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_DevCase_Controls_DevCheckBox__ctor">DevCheckBox</a></td><td>
Initializes a new instance of the DevCheckBox class.</td></tr></table>&nbsp;
<a href="#devcheckbox-class">Back to Top</a>

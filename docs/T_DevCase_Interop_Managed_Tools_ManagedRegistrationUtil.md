...
System.Object<br />&nbsp;&nbsp;DevCase.Interop.Managed.Tools.ManagedRegistrationUtil<br />
...
**C#**<br />
``` C#
public sealed class ManagedRegistrationUtil
```

**VB**<br />
``` VB
Public NotInheritable Class ManagedRegistrationUtil
```

**VB Usage**<br />
``` VB Usage
Dim instance As ManagedRegistrationUtil
```

**C++**<br />
``` C++
public ref class ManagedRegistrationUtil sealed
```

**F#**<br />
``` F#
[<SealedAttribute>]
type ManagedRegistrationUtil =  class end
```

The ManagedRegistrationUtil type exposes the following members.
...
<a href="#managedregistrationutil-class">Back to Top</a>

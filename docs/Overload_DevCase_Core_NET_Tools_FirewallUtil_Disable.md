...
## Overload List
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")![Static member](media/static.gif "Static member")</td><td><a href="M_DevCase_Core_NET_Tools_FirewallUtil_Disable">Disable()</a></td><td>
...
Disables the Windows Firewall for the specified network profile.</td></tr></table>&nbsp;
<a href="#firewallutil.disable-method">Back to Top</a>

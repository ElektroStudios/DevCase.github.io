# ControlIterator.AsyncCheck(*T*) Method (Control, String)
 

Asynchronously Check all the Controls of the specified Type on the specified Control Container.
...
returnValue = ControlIterator.AsyncCheck(controlContainer, 
	containsName)
```

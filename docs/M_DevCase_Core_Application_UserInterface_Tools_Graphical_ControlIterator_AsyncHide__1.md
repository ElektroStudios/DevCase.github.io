# ControlIterator.AsyncHide(*T*) Method (String)
 

Asynchronously Hide all the Controls of the specified Type on the active Formulary.
...
returnValue = ControlIterator.AsyncHide(containsName)
```

...
Contains custom extension methods to use with an NameValueCollection.


## Inheritance Hierarchy
System.Object<br />&nbsp;&nbsp;DevCase.Core.Extensions.NameValueCollection.NameValueCollectionExtensions<br />
...
public sealed class NameValueCollectionExtensions
```
...
**VB Usage**<br />
``` VB Usage
Dim instance As NameValueCollectionExtensions
```
...
[ExtensionAttribute]
[HideModuleNameAttribute]
public ref class NameValueCollectionExtensions sealed
```
...
[<ExtensionAttribute>]
[<HideModuleNameAttribute>]
type NameValueCollectionExtensions =  class end
```
...
## Methods
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")![Static member](media/static.gif "Static member")</td><td><a href="M_DevCase_Core_Extensions_NameValueCollection_NameValueCollectionExtensions_ToDictionary">ToDictionary</a></td><td>
Converts a NameValueCollection to Dictionary(TKey, TValue).</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")![Static member](media/static.gif "Static member")![Code example](media/CodeExample.png "Code example")</td><td><a href="M_DevCase_Core_Extensions_NameValueCollection_NameValueCollectionExtensions_ToQueryString">ToQueryString(NameValueCollection)</a></td><td>
...
Converts the name and values of a NameValueCollection to a formatted web-request query string. 
 ...
 Consider this method to be the opposite of ParseQueryString(String).</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")![Static member](media/static.gif "Static member")![Code example](media/CodeExample.png "Code example")</td><td><a href="M_DevCase_Core_Extensions_NameValueCollection_NameValueCollectionExtensions_ToUri">ToUri</a></td><td>
Converts the name and values of a NameValueCollection to a formatted web-request query string. 

 Consider this method to be the opposite of ParseQueryString(String).</td></tr></table>&nbsp;
<a href="#namevaluecollectionextensions-class">Back to Top</a>
...
#### Reference
<a href="N_DevCase_Core_Extensions_NameValueCollection">DevCase.Core.Extensions.NameValueCollection Namespace</a><br />
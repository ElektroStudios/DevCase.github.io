...
**C++**<br />
``` C++
public value class RawInput
```

**F#**<br />
``` F#
[<SealedAttribute>]
type RawInput =  struct end
```

The RawInput type exposes the following members.
...
<a href="#rawinput-structure">Back to Top</a>
...
## Remarks
<a href="https://msdn.microsoft.com/en-us/library/windows/desktop/ms645562%28v=vs.85%29.aspx" target="_blank">https://msdn.microsoft.com/en-us/library/windows/desktop/ms645562%28v=vs.85%29.aspx</a>

...
**C#**<br />
``` C#
public class StarRateValueChangedEventArgs : ValueChangedEventArgs<int>
```

**VB**<br />
``` VB
Public Class StarRateValueChangedEventArgs
...
**C++**<br />
``` C++
public ref class StarRateValueChangedEventArgs : public ValueChangedEventArgs<int>
```

**F#**<br />
``` F#
type StarRateValueChangedEventArgs =  
    class
        inherit ValueChangedEventArgs<int>
    end
```

The StarRateValueChangedEventArgs type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_DevCase_Controls_Eventing_StarRateValueChangedEventArgs__ctor">StarRateValueChangedEventArgs</a></td><td>
Initializes a new instance of the StarRateValueChangedEventArgs class.</td></tr></table>&nbsp;
<a href="#starratevaluechangedeventargs-class">Back to Top</a>

# MailUtil.SendMailText Method (SmtpClient, NetworkCredential, String, String, MailAddressCollection)
...
Dim body As String
Dim addresses As MailAddressCollectionMailUtil.SendMailText(smtpClient, credential, 
...
SendMailText(DevCase.Core.NET.SmtpClients.MicrosoftLiveSmtpClient, credential, "Email Subject", "Message Body", addressCollection)
```

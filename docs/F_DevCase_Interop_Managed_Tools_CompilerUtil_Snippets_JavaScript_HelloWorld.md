# CompilerUtil.Snippets.JavaScript.HelloWorld Field
 

A sourcecode template of a `Hello World` script written in `JavaScript`.
...
value = CompilerUtil.Snippets.JavaScript.HelloWorld

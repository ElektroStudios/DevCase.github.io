# EnvironmentFolders.ProgramsPath Property 
...
**VB**<br />
``` VB
Public Shared ReadOnly Property ProgramsPath ( 
...
value = EnvironmentFolders.ProgramsPath(folderOption)
...
``` C++
public:
static property String^ ProgramsPath[Environment.SpecialFolderOption folderOption = Environment.SpecialFolderOption::None] {
...
**F#**<br />
``` F#
static member ProgramsPath : string with get
...
#### Property Value
Type: String<br />\[Missing <value> documentation for "P:DevCase.Core.Shell.EnvironmentFolders.ProgramsPath(System.Environment.SpecialFolderOption)"\]

## Examples
This is a code example. 
**VB**<br />
``` VB
Console.WriteLine($"{NameOf(EnvironmentFolders.ProgramsPath)}={EnvironmentFolders.ProgramsPath}")
```

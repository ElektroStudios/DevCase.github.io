# DriveClient.GetOwnedFiles Method (Func(File, Boolean))
 

Gets the files stored in the current user account that are owned by him and matches the specified search criteria.
...
returnValue = instance.GetOwnedFiles(predicate)
```
...
#### Parameters
&nbsp;<dl><dt>predicate</dt><dd>Type: System.Func(File, Boolean)<br />\[Missing <param name="predicate"/> documentation for "M:DevCase.ThirdParty.Google.Drive.DriveClient.GetOwnedFiles(System.Func{Google.Apis.Drive.v3.Data.File,System.Boolean})"\]</dd></dl>
...
Dim files As List(Of Google.Apis.Drive.v3.Data.File) = client.GetOwnedFiles(predicate)

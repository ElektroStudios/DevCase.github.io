# ControlIterator.AsyncShow(*T*) Method (String)
 

Asynchronously Show all the Controls of the specified Type on the active Formulary.
...
returnValue = ControlIterator.AsyncShow(containsName)
```

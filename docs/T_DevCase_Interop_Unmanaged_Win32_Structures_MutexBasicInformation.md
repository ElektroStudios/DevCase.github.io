# MutexBasicInformation Structure
...
**C#**<br />
``` C#
public struct MutexBasicInformation
```

**VB**<br />
``` VB
Public Structure MutexBasicInformation
```
...
**C++**<br />
``` C++
public value class MutexBasicInformation
```

**F#**<br />
``` F#
[<SealedAttribute>]
type MutexBasicInformation =  struct end
```

The MutexBasicInformation type exposes the following members.
...
<a href="#mutexbasicinformation-structure">Back to Top</a>

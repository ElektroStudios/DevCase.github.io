...
System.Object<br />&nbsp;&nbsp;<a href="T_DevCase_Core_Design_AestheticObject">DevCase.Core.Design.AestheticObject</a><br />&nbsp;&nbsp;&nbsp;&nbsp;DevCase.ThirdParty.IconPro.IconProUtil<br />
...
**C#**<br />
``` C#
public sealed class IconProUtil : AestheticObject
```

**VB**<br />
``` VB
Public NotInheritable Class IconProUtil
	Inherits AestheticObject
```

**VB Usage**<br />
``` VB Usage
Dim instance As IconProUtil
```

**C++**<br />
``` C++
public ref class IconProUtil sealed : public AestheticObject
```
...
The IconProUtil type exposes the following members.
...
Creates a icon from the specified Image.</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")![Static member](media/static.gif "Static member")![Code example](media/CodeExample.png "Code example")</td><td><a href="M_DevCase_ThirdParty_IconPro_IconProUtil_CreateIconBitmapEncoder">CreateIconBitmapEncoder(Bitmap, Int32[])</a></td><td>
...
<a href="#iconproutil-class">Back to Top</a>
...
#### Reference
<a href="N_DevCase_ThirdParty_IconPro">DevCase.ThirdParty.IconPro Namespace</a><br />
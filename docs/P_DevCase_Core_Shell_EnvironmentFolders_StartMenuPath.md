# EnvironmentFolders.StartMenuPath Property 
...
**VB**<br />
``` VB
Public Shared ReadOnly Property StartMenuPath ( 
...
value = EnvironmentFolders.StartMenuPath(folderOption)
...
``` C++
public:
static property String^ StartMenuPath[Environment.SpecialFolderOption folderOption = Environment.SpecialFolderOption::None] {
...
**F#**<br />
``` F#
static member StartMenuPath : string with get
...
#### Property Value
Type: String<br />\[Missing <value> documentation for "P:DevCase.Core.Shell.EnvironmentFolders.StartMenuPath(System.Environment.SpecialFolderOption)"\]

## Examples
This is a code example. 
**VB**<br />
``` VB
Console.WriteLine($"{NameOf(EnvironmentFolders.StartMenuPath)}={EnvironmentFolders.StartMenuPath}")
```

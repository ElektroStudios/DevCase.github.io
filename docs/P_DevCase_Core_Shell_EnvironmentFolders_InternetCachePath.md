# EnvironmentFolders.InternetCachePath Property 
...
**VB**<br />
``` VB
Public Shared ReadOnly Property InternetCachePath ( 
...
value = EnvironmentFolders.InternetCachePath(folderOption)
...
``` C++
public:
static property String^ InternetCachePath[Environment.SpecialFolderOption folderOption = Environment.SpecialFolderOption::None] {
...
**F#**<br />
``` F#
static member InternetCachePath : string with get
...
#### Property Value
Type: String<br />\[Missing <value> documentation for "P:DevCase.Core.Shell.EnvironmentFolders.InternetCachePath(System.Environment.SpecialFolderOption)"\]

## Examples
This is a code example. 
**VB**<br />
``` VB
Console.WriteLine($"{NameOf(EnvironmentFolders.InternetCachePath)}={EnvironmentFolders.InternetCachePath}")
```

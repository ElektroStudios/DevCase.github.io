# VmRunWrapper.SharedFoldersDisable Method 
...
**C#**<br />
``` C#
public void SharedFoldersDisable(
...
**VB**<br />
``` VB
Public Sub SharedFoldersDisable ( 
...
instance.SharedFoldersDisable(vm)
```

**C++**<br />
``` C++
public:
void SharedFoldersDisable(
	VMWareVirtualMachine^ vm
)
```

# Litecoin.GetPrice Method (Double, Currencies)
 

Gets the price for the specified amount of Litecoins converted to the specified currency.
...
#### Return Value
Type: Double<br />The resulting price for the specified amount of Litecoins converted to the specified currency.

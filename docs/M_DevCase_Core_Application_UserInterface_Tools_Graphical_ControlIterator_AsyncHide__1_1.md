# ControlIterator.AsyncHide(*T*) Method (Control, String)
 

Asynchronously Hide all the Controls of the specified Type on the specified Container.
...
returnValue = ControlIterator.AsyncHide(controlContainer, 
	containsName)
```

# ControlIterator.AsyncUncheck(*T*) Method (Control, String)
 

Asynchronously Uncheck all the Controls of the specified Type on the specified Control Container.
...
returnValue = ControlIterator.AsyncUncheck(controlContainer, 
	containsName)
```

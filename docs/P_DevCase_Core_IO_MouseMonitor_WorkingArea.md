# MouseMonitor.WorkingArea Property 
 

Gets or sets the screen's working area on which to notify about mouse events. 

 The events fired by this <a href="T_DevCase_Core_IO_MouseMonitor">MouseMonitor</a> will be restricted to the bounds of the specified rectangle.

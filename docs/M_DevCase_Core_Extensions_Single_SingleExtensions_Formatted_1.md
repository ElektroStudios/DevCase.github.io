# SingleExtensions.Formatted Method (Single, Int32)
...
#### Parameters
&nbsp;<dl><dt>sender</dt><dd>Type: System.Single<br />The source value.</dd><dt>precision</dt><dd>Type: System.Int32<br />The decimals precision.</dd></dl>
...
**VB**<br />
``` VB
Dim number As String = 10000.0F.Formatted(precision:=0)
```

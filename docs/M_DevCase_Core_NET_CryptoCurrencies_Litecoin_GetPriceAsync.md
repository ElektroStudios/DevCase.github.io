# Litecoin.GetPriceAsync Method (Currencies)
 

Asynchronously gets the price for 1 Litecoins converted to the specified currency.
...
#### Return Value
Type: Task(Double)<br />The resulting price for 1 Litecoins converted to the specified currency.

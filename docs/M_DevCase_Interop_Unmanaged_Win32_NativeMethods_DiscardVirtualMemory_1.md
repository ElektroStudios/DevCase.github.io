# NativeMethods.DiscardVirtualMemory Method (IntPtr, UInt32)
...
#### Parameters
&nbsp;<dl><dt>address</dt><dd>Type: System.IntPtr<br />Page-aligned starting address of the memory to discard.</dd><dt>size</dt><dd>Type: System.UInt32<br />Size, in bytes, of the memory region to discard. *size* must be an integer multiple of the system page size.</dd></dl>

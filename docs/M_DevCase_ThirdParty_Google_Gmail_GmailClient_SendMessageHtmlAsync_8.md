# GmailClient.SendMessageHtmlAsync Method (String, String, String, Attachment[])
...
**VB**<br />
``` VB
Await SendMessageHtmlAsync("Email Subject", "Message Body", "address@domain.com", New Attachment("C:\File.txt"))
```

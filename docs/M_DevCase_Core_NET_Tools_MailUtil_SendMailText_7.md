# MailUtil.SendMailText Method (SmtpClient, NetworkCredential, String, String, String, ICollection(Attachment))
...
SendMailText(DevCase.Core.NET.SmtpClients.MicrosoftLiveSmtpClient, credential, "Email Subject", "Message Body", "address@domain.com", attachments)
```

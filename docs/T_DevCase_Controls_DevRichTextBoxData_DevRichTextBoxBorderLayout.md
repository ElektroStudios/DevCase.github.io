# DevRichTextBoxBorderLayout Class
 

Provides the layout that determines the appearance of the borber of a <a href="T_DevCase_Controls_DevRichTextBox">DevRichTextBox</a> control.


## Inheritance Hierarchy
System.Object<br />&nbsp;&nbsp;System.MarshalByRefObject<br />&nbsp;&nbsp;&nbsp;&nbsp;System.ComponentModel.Component<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="T_DevCase_Core_Design_AestheticComponent">DevCase.Core.Design.AestheticComponent</a><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;DevCase.Controls.DevRichTextBoxData.DevRichTextBoxBorderLayout<br />
...
**C#**<br />
``` C#
public sealed class DevRichTextBoxBorderLayout : AestheticComponent
```

**VB**<br />
``` VB
Public NotInheritable Class DevRichTextBoxBorderLayout
...
**C++**<br />
``` C++
public ref class DevRichTextBoxBorderLayout sealed : public AestheticComponent
```

**F#**<br />
``` F#
[<SealedAttribute>]
type DevRichTextBoxBorderLayout =  
    class
        inherit AestheticComponent
    end
```

The DevRichTextBoxBorderLayout type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_DevCase_Controls_DevRichTextBoxData_DevRichTextBoxBorderLayout__ctor">DevRichTextBoxBorderLayout</a></td><td>
Initializes a new instance of the DevRichTextBoxBorderLayout class.</td></tr></table>&nbsp;
<a href="#devrichtextboxborderlayout-class">Back to Top</a>

# HttpWebResponseExtensions Class
 

Contains custom extension methods to use with the HttpWebResponse type.


## Inheritance Hierarchy
System.Object<br />&nbsp;&nbsp;DevCase.Core.Extensions.HttpWebResponse.HttpWebResponseExtensions<br />
...
public sealed class HttpWebResponseExtensions
```
...
<ExtensionAttribute>
<HideModuleNameAttribute>
Public NotInheritable Class HttpWebResponseExtensions
```

**VB Usage**<br />
``` VB Usage
Dim instance As HttpWebResponseExtensions
```
...
[ExtensionAttribute]
[HideModuleNameAttribute]
public ref class HttpWebResponseExtensions sealed
```
...
[<ExtensionAttribute>]
[<HideModuleNameAttribute>]
type HttpWebResponseExtensions =  class end
```

The HttpWebResponseExtensions type exposes the following members.
...
<a href="#httpwebresponseextensions-class">Back to Top</a>
...
#### Reference
<a href="N_DevCase_Core_Extensions_HttpWebResponse">DevCase.Core.Extensions.HttpWebResponse Namespace</a><br />
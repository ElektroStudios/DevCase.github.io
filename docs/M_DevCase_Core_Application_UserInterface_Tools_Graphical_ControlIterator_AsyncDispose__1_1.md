# ControlIterator.AsyncDispose(*T*) Method (Control, String)
 

Asynchronously Dispose all the Controls of the specified Type on the specified Control Container.
...
returnValue = ControlIterator.AsyncDispose(controlContainer, 
	containsName)
```

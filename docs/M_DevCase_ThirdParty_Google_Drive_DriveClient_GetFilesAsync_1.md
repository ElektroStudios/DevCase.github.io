# DriveClient.GetFilesAsync Method (Func(File, Boolean))
...
returnValue = instance.GetFilesAsync(predicate)
```
...
#### Parameters
&nbsp;<dl><dt>predicate</dt><dd>Type: System.Func(File, Boolean)<br />\[Missing <param name="predicate"/> documentation for "M:DevCase.ThirdParty.Google.Drive.DriveClient.GetFilesAsync(System.Func{Google.Apis.Drive.v3.Data.File,System.Boolean})"\]</dd></dl>
...
Dim files As List(Of Google.Apis.Drive.v3.Data.File) = Await client.GetFilesAsync(predicate)

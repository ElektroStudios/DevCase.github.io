...
System.Object<br />&nbsp;&nbsp;<a href="T_DevCase_Core_Design_AestheticObject">DevCase.Core.Design.AestheticObject</a><br />&nbsp;&nbsp;&nbsp;&nbsp;DevCase.ThirdParty.AForge.AForgeUtil<br />
...
**C#**<br />
``` C#
public sealed class AForgeUtil : AestheticObject
```
...
**VB Usage**<br />
``` VB Usage
Dim instance As AForgeUtil
```

**C++**<br />
``` C++
public ref class AForgeUtil sealed : public AestheticObject
```
...
The AForgeUtil type exposes the following members.
...
<a href="#aforgeutil-class">Back to Top</a>
...
#### Reference
<a href="N_DevCase_ThirdParty_AForge">DevCase.ThirdParty.AForge Namespace</a><br />
# ControlIterator.AsyncShow(*T*) Method (Control, String)
 

Asynchronously Show all the Controls of the specified Type on the specified Container.
...
returnValue = ControlIterator.AsyncShow(controlContainer, 
	containsName)
```

# Ripple.GetPriceAsync Method (Double, Currencies)
 

Asynchronously gets the price for the specified amount of Ripples converted to the specified currency.
...
#### Return Value
Type: Task(Double)<br />The resulting price for the specified amount of Ripples converted to the specified currency.

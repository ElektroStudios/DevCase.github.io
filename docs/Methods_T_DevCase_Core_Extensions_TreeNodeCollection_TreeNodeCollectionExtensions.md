# TreeNodeCollectionExtensions Methods
 

The <a href="T_DevCase_Core_Extensions_TreeNodeCollection_TreeNodeCollectionExtensions">TreeNodeCollectionExtensions</a> type exposes the following members.
...
Given the specified file path, this function resolves its icon and adds a new tree node to the end of the source TreeNodeCollection collection. 
 ...
 This tree node contains the file name and its icon as image index.</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")![Static member](media/static.gif "Static member")</td><td><a href="M_DevCase_Core_Extensions_TreeNodeCollection_TreeNodeCollectionExtensions_AsEnumerable">AsEnumerable</a></td><td>
Enumerates all the TreeNode items in the specified specified TreeNodeCollection collection, and returns a IEnumerable(T) collection.</td></tr></table>&nbsp;
<a href="#treenodecollectionextensions-methods">Back to Top</a>

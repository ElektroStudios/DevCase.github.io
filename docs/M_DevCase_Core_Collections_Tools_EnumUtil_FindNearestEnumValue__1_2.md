# EnumUtil.FindNearestEnumValue(*T*) Method (Int64, EnumFindDirection)
...
#### Parameters
&nbsp;<dl><dt>value</dt><dd>Type: System.Int64<br />The existing value.</dd><dt>direction</dt><dd>Type: <a href="T_DevCase_Core_Collections_EnumFindDirection">DevCase.Core.Collections.EnumFindDirection</a><br />The find direction of the nearest value.</dd></dl>

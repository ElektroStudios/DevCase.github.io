# GmailClient.SendMessageText Method (String, String, MailAddressCollection, ICollection(Attachment))
...
#### Return Value
Type: String<br />\[Missing <returns> documentation for "M:DevCase.ThirdParty.Google.Gmail.GmailClient.SendMessageText(System.String,System.String,System.Net.Mail.MailAddressCollection,System.Collections.Generic.ICollection{System.Net.Mail.Attachment})"\]
...
SendMessageText("Email Subject", "Message Body", addressCollection, attachments)
```

# NativeMethods.CreateFileA Method (String, FileAccessRights, FileShare, IntPtr, FileMode, FileAttributes, IntPtr)
...
returnValue = NativeMethods.CreateFileA(filepath, 
	...
	creationDisposition, attributes, 
	templateFile)
```

# CompilerUtil.Snippets.VisualBasicNET Class
 

Contains predefined snippets and source-code templates for `Visual Basic.NET` language.


## Inheritance Hierarchy
System.Object<br />&nbsp;&nbsp;DevCase.Interop.Managed.Tools.CompilerUtil.Snippets.VisualBasicNET<br />
...
**C#**<br />
``` C#
public sealed class VisualBasicNET
```

**VB**<br />
``` VB
Public NotInheritable Class VisualBasicNET
```

**VB Usage**<br />
``` VB Usage
Dim instance As CompilerUtil.Snippets.VisualBasicNET
```

**C++**<br />
``` C++
public ref class VisualBasicNET sealed
```

**F#**<br />
``` F#
[<SealedAttribute>]
type VisualBasicNET =  class end
```

The CompilerUtil.Snippets.VisualBasicNET type exposes the following members.
...
<a href="#compilerutil.snippets.visualbasicnet-class">Back to Top</a>

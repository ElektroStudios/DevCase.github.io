# GmailClient.SendMessageHtmlAsync Method (String, String, MailAddressCollection)
...
#### Return Value
Type: Task(String)<br />\[Missing <returns> documentation for "M:DevCase.ThirdParty.Google.Gmail.GmailClient.SendMessageHtmlAsync(System.String,System.String,System.Net.Mail.MailAddressCollection)"\]
...
Await SendMessageHtmlAsync("Email Subject", "Message Body", addressCollection)
```

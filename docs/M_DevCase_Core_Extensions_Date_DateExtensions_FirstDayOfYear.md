# DateExtensions.FirstDayOfYear Method 
 

Returns a DateTime representing the first day of the year for the date represented by the specified DateTime.
...
#### Return Value
Type: DateTime<br />A DateTime representing the first day of the year for the date represented by the specified DateTime.

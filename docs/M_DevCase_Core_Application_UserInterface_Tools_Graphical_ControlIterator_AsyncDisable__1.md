# ControlIterator.AsyncDisable(*T*) Method (String)
 

Asynchronously Disable all the Controls of the specified Type on the active Formulary.
...
returnValue = ControlIterator.AsyncDisable(containsName)
```

# NativeMethods.NtOpenSection Method (IntPtr, SectionAccessRights, IntPtr)
...
static NTStatus NtOpenSection(
	...
	[InAttribute] SectionAccessRights desiredAccess, 

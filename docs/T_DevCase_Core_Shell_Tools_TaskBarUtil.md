...
Contains Windows TaskBar related utilities.


## Inheritance Hierarchy
System.Object<br />&nbsp;&nbsp;<a href="T_DevCase_Core_Design_AestheticObject">DevCase.Core.Design.AestheticObject</a><br />&nbsp;&nbsp;&nbsp;&nbsp;DevCase.Core.Shell.Tools.TaskBarUtil<br />
...
**C#**<br />
``` C#
public sealed class TaskBarUtil : AestheticObject
```

**VB**<br />
``` VB
Public NotInheritable Class TaskBarUtil
	Inherits AestheticObject
```

**VB Usage**<br />
``` VB Usage
Dim instance As TaskBarUtil
```

**C++**<br />
``` C++
public ref class TaskBarUtil sealed : public AestheticObject
```
...
The TaskBarUtil type exposes the following members.
...
<a href="#taskbarutil-class">Back to Top</a>

# NativeMethods.VirtualAllocExNuma Method (IntPtr, UIntPtr, UIntPtr, MemoryAllocationType, MemoryProtectionOptions, UInt32)
...
&nbsp;<dl><dt>hProcess</dt><dd>Type: System.IntPtr<br />The handle to a process. 
 ...
 If *address* is Zero, the function determines where to allocate the region.</dd><dt>size</dt><dd>Type: System.UIntPtr<br />The size of the region of memory to allocate, in bytes. 

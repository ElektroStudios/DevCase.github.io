# GmailClient.SendMessageTextAsync Method (String, String, String[])
...
#### Return Value
Type: Task(String)<br />\[Missing <returns> documentation for "M:DevCase.ThirdParty.Google.Gmail.GmailClient.SendMessageTextAsync(System.String,System.String,System.String[])"\]

## Examples
This is a code example. 
**VB**<br />
``` VB
Await SendMessageTextAsync("Email Subject", "Message Body", {"address1@domain.com", "address2@domain.com"})
```

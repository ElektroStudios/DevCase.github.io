...
Returns a string representation for this <a href="T_DevCase_Controls_DevProgressBar">DevProgressBar</a>.
 (Overrides ProgressBar.ToString().)</td></tr></table>&nbsp;
<a href="#devprogressbar-methods">Back to Top</a>

# DateExtensions.IsNow Method 
 

Determines whether the specified DateTime is now.
...
#### Return Value
Type: Boolean<br />`true` (`True` in Visual Basic) if the specified DateTime is now; otherwise, `false` (`False` in Visual Basic).

...
**VB**<br />
``` VB
Public Const Ipv4 As String = "/^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$/"
```
...
``` C++
public:
literal String^ Ipv4 = "/^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$/"
```

**F#**<br />
``` F#
static val mutable Ipv4: string
```

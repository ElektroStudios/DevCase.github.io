...
**C#**<br />
``` C#
public struct DevModeFlags
```

**VB**<br />
``` VB
Public Structure DevModeFlags
```
...
**C++**<br />
``` C++
public value class DevModeFlags
```

**F#**<br />
``` F#
[<SealedAttribute>]
type DevModeFlags =  struct end
```

The DevModeFlags type exposes the following members.
...
<a href="#devmodeflags-structure">Back to Top</a>

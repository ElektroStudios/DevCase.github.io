# EnvironmentFolders.CommonStartMenuPath Property 
...
**VB**<br />
``` VB
Public Shared ReadOnly Property CommonStartMenuPath ( 
...
value = EnvironmentFolders.CommonStartMenuPath(folderOption)
...
``` C++
public:
static property String^ CommonStartMenuPath[Environment.SpecialFolderOption folderOption = Environment.SpecialFolderOption::None] {
...
**F#**<br />
``` F#
static member CommonStartMenuPath : string with get
...
#### Property Value
Type: String<br />\[Missing <value> documentation for "P:DevCase.Core.Shell.EnvironmentFolders.CommonStartMenuPath(System.Environment.SpecialFolderOption)"\]

## Examples
This is a code example. 
**VB**<br />
``` VB
Console.WriteLine($"{NameOf(EnvironmentFolders.CommonStartMenuPath)}={EnvironmentFolders.CommonStartMenuPath}")
```

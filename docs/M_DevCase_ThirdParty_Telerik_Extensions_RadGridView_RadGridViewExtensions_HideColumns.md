# RadGridViewExtensions.HideColumns Method (RadGridView, Int32[])
...
#### Parameters
&nbsp;<dl><dt>sender</dt><dd>Type: RadGridView<br />The source RadGridView.</dd><dt>columnIndices</dt><dd>Type: System.Int32[]<br />The indices of the columns to hide.</dd></dl>

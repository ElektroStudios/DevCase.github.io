# WebUtil.DownloadWebpage Method (String, Encoding, KeyValuePair(String, String)[])
...
**VB**<br />
``` VB
Dim html As String = DownloadWebpage("http://www.elhacker.net/", Encoding.UTF8, New KeyValuePair(Of String, String)("user-agent", "Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.2; .NET CLR 1.0.3705;)"))
```

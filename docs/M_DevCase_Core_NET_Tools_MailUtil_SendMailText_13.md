# MailUtil.SendMailText Method (SmtpClient, String, String, String, String, MailAddress, ICollection(Attachment))
...
SendMailText(DevCase.Core.NET.SmtpClients.MicrosoftLiveSmtpClient, "Username@Hotmail.com", "Password", "Email Subject", "Message Body", New MailAddress("address@domain.com"), attachments)
```

# ByteExtensions.ToString Method (Byte[], Encoding)
...
#### Parameters
&nbsp;<dl><dt>sender</dt><dd>Type: System.Byte[]<br />The source Array.</dd><dt>enc</dt><dd>Type: System.Text.Encoding<br />The character Encoding to decode the bytes.</dd></dl>

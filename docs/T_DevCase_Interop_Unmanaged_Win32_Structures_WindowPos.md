...
``` F#
[<SealedAttribute>]
type WindowPos =  struct end
```

The WindowPos type exposes the following members.
...
<a href="#windowpos-structure">Back to Top</a>
...
## Remarks
<a href="https://msdn.microsoft.com/en-us/library/windows/desktop/ms632612%28v=vs.85%29.aspx" target="_blank">https://msdn.microsoft.com/en-us/library/windows/desktop/ms632612%28v=vs.85%29.aspx</a>

# ControlIterator.AsyncToggleVisible(*T*) Method (Control.ControlCollection, String)
 

Asynchronously Toggle the visible state of all the Controls of the specified Type on the specified Control Collection.
...
returnValue = ControlIterator.AsyncToggleVisible(controlCollection, 
	containsName)
```

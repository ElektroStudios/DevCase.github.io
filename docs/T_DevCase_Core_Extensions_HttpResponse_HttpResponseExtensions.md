...
Contains custom extension methods to use with the HttpResponse type.


## Inheritance Hierarchy
System.Object<br />&nbsp;&nbsp;DevCase.Core.Extensions.HttpResponse.HttpResponseExtensions<br />
...
public sealed class HttpResponseExtensions
```
...
<ExtensionAttribute>
<HideModuleNameAttribute>
Public NotInheritable Class HttpResponseExtensions
```

**VB Usage**<br />
``` VB Usage
Dim instance As HttpResponseExtensions
```
...
[ExtensionAttribute]
[HideModuleNameAttribute]
public ref class HttpResponseExtensions sealed
```
...
[<ExtensionAttribute>]
[<HideModuleNameAttribute>]
type HttpResponseExtensions =  class end
```

The HttpResponseExtensions type exposes the following members.
...
Adds an attachment.</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")![Static member](media/static.gif "Static member")</td><td><a href="M_DevCase_Core_Extensions_HttpResponse_HttpResponseExtensions_Reload">Reload</a></td><td>
Reloads the source HttpResponse.</td></tr></table>&nbsp;
<a href="#httpresponseextensions-class">Back to Top</a>
...
#### Reference
<a href="N_DevCase_Core_Extensions_HttpResponse">DevCase.Core.Extensions.HttpResponse Namespace</a><br />
...
System.Object<br />&nbsp;&nbsp;DevCase.Core.Extensions.Assembly.AssemblyExtensions<br />
...
**VB Usage**<br />
``` VB Usage
Dim instance As AssemblyExtensions
```
...
[ExtensionAttribute]
[HideModuleNameAttribute]
public ref class AssemblyExtensions sealed
```
...
#### Reference
<a href="N_DevCase_Core_Extensions_Assembly">DevCase.Core.Extensions.Assembly Namespace</a><br />
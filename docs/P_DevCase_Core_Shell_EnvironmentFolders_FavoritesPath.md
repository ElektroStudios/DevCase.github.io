# EnvironmentFolders.FavoritesPath Property 
...
**VB**<br />
``` VB
Public Shared ReadOnly Property FavoritesPath ( 
...
value = EnvironmentFolders.FavoritesPath(folderOption)
...
``` C++
public:
static property String^ FavoritesPath[Environment.SpecialFolderOption folderOption = Environment.SpecialFolderOption::None] {
...
**F#**<br />
``` F#
static member FavoritesPath : string with get
...
#### Property Value
Type: String<br />\[Missing <value> documentation for "P:DevCase.Core.Shell.EnvironmentFolders.FavoritesPath(System.Environment.SpecialFolderOption)"\]

## Examples
This is a code example. 
**VB**<br />
``` VB
Console.WriteLine($"{NameOf(EnvironmentFolders.FavoritesPath)}={EnvironmentFolders.FavoritesPath}")
```

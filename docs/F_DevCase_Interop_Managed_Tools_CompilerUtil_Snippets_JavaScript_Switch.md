# CompilerUtil.Snippets.JavaScript.Switch Field
 

A snippet of a `Switch` example written in `JavaScript`.
...
**VB**<br />
``` VB
Public Shared ReadOnly Switch As String
```
...
value = CompilerUtil.Snippets.JavaScript.Switch
...
``` C++
public:
static initonly String^ Switch
```

**F#**<br />
``` F#
static val Switch: string
```

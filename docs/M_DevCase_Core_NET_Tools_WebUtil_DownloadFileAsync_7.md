# WebUtil.DownloadFileAsync Method (String, String, String, DownloadProgressChangedEventHandler, AsyncCompletedEventHandler)
...
Dim callbackDownloadFileCompleted As AsyncCompletedEventHandlerWebUtil.DownloadFileAsync(url, dirpath, 
	filename, callbackDownloadProgressChanged, 

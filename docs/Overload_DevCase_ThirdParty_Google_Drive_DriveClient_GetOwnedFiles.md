...
## Overload List
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")![Code example](media/CodeExample.png "Code example")</td><td><a href="M_DevCase_ThirdParty_Google_Drive_DriveClient_GetOwnedFiles">GetOwnedFiles()</a></td><td>
...
Gets the files stored in the current user account that are owned by him and matches the specified search criteria.</td></tr></table>&nbsp;
<a href="#driveclient.getownedfiles-method">Back to Top</a>

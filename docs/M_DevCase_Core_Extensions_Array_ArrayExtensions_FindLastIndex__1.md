# ArrayExtensions.FindLastIndex(*T*) Method (*T*[,], Predicate(*T*))
 

Searches for an element in the source four-dimensional array that matches the conditions defined by the specified predicate, and returns the index of its last occurrence.

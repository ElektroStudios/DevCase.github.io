...
**C++**<br />
``` C++
public value class RawHid
```

**F#**<br />
``` F#
[<SealedAttribute>]
type RawHid =  struct end
```

The RawHid type exposes the following members.
...
<a href="#rawhid-structure">Back to Top</a>
...
## Remarks
<a href="https://msdn.microsoft.com/en-us/library/windows/desktop/ms645549%28v=vs.85%29.aspx" target="_blank">https://msdn.microsoft.com/en-us/library/windows/desktop/ms645549%28v=vs.85%29.aspx</a>

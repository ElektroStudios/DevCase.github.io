# DevListBoxGridLayout Class
 

Provides the layout that determines the appearance of the grid of a <a href="T_DevCase_Controls_DevListBox">DevListBox</a> control.


## Inheritance Hierarchy
System.Object<br />&nbsp;&nbsp;System.MarshalByRefObject<br />&nbsp;&nbsp;&nbsp;&nbsp;System.ComponentModel.Component<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="T_DevCase_Core_Design_AestheticComponent">DevCase.Core.Design.AestheticComponent</a><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;DevCase.Controls.DevListBoxData.DevListBoxGridLayout<br />
...
**C#**<br />
``` C#
public sealed class DevListBoxGridLayout : AestheticComponent
```

**VB**<br />
``` VB
Public NotInheritable Class DevListBoxGridLayout
...
**C++**<br />
``` C++
public ref class DevListBoxGridLayout sealed : public AestheticComponent
```

**F#**<br />
``` F#
[<SealedAttribute>]
type DevListBoxGridLayout =  
    class
        inherit AestheticComponent
    end
```

The DevListBoxGridLayout type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_DevCase_Controls_DevListBoxData_DevListBoxGridLayout__ctor">DevListBoxGridLayout</a></td><td>
Initializes a new instance of the DevListBoxGridLayout class.</td></tr></table>&nbsp;
<a href="#devlistboxgridlayout-class">Back to Top</a>

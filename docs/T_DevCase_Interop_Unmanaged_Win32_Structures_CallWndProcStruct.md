# CallWndProcStruct Structure
 

Defines the message parameters passed to a <a href="T_DevCase_Interop_Unmanaged_Win32_Enums_HookType">CallWndProc</a> hook procedure.
...
**C#**<br />
``` C#
public struct CallWndProcStruct
```

**VB**<br />
``` VB
Public Structure CallWndProcStruct
```
...
**C++**<br />
``` C++
public value class CallWndProcStruct
```

**F#**<br />
``` F#
[<SealedAttribute>]
type CallWndProcStruct =  struct end
```

The CallWndProcStruct type exposes the following members.
...
<a href="#callwndprocstruct-structure">Back to Top</a>
...
## Remarks
See `CallWndProcStruct` (`CWPSTRUCT`) structure: <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/ms644975(v=vs.85).aspx" target="_blank">https://msdn.microsoft.com/en-us/library/windows/desktop/ms644975(v=vs.85).aspx</a>. 

 See `CallWndProc` callback function: <a href="https://msdn.microsoft.com/en-us/library/windows/desktop/ms644975%28v=vs.85%29.aspx" target="_blank">https://msdn.microsoft.com/en-us/library/windows/desktop/ms644975%28v=vs.85%29.aspx</a>.

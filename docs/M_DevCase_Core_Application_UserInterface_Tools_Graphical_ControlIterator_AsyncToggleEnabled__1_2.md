# ControlIterator.AsyncToggleEnabled(*T*) Method (Control.ControlCollection, String)
 

Asynchronously Toggle the enabled state of all the Controls of the specified Type on the specified Control Collection.
...
**C#**<br />
``` C#
public static bool AsyncToggleEnabled<T>(
...
**VB**<br />
``` VB
Public Shared Function AsyncToggleEnabled(Of T As Control) ( 
...
returnValue = ControlIterator.AsyncToggleEnabled(controlCollection, 
	containsName)
```

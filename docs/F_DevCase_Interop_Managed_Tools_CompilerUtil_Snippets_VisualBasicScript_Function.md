# CompilerUtil.Snippets.VisualBasicScript.Function Field
 

A snippet of a empty function written in `Visual Basic Script`.
...
value = CompilerUtil.Snippets.VisualBasicScript.Function

# IWebDriverExtensions.FindElementsByText Method 
...
Finds a list of elements using the given mechanism that match the text supplied.</td></tr></table>&nbsp;
<a href="#iwebdriverextensions.findelementsbytext-method">Back to Top</a>

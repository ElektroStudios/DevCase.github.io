# IEnumerableExtensions.CountNonEmptyItems(*T*) Method 
...
public static int CountNonEmptyItems<T>(
...
<ExtensionAttribute>
<EditorBrowsableAttribute(EditorBrowsableState.Always)>
Public Shared Function CountNonEmptyItems(Of T) ( 
...
#### Type Parameters
&nbsp;<dl><dt>T</dt><dd>\[Missing <typeparam name="T"/> documentation for "M:DevCase.Core.Extensions.IEnumerable.IEnumerableExtensions.CountNonEmptyItems``1(System.Collections.Generic.IEnumerable{``0})"\]</dd></dl>

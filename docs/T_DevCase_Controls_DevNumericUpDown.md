# DevNumericUpDown Class
 

A extended NumericUpDown control.


## Inheritance Hierarchy
System.Object<br />&nbsp;&nbsp;System.MarshalByRefObject<br />&nbsp;&nbsp;&nbsp;&nbsp;System.ComponentModel.Component<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;System.Windows.Forms.Control<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;System.Windows.Forms.ScrollableControl<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;System.Windows.Forms.ContainerControl<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;System.Windows.Forms.UpDownBase<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;System.Windows.Forms.NumericUpDown<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;DevCase.Controls.DevNumericUpDown<br />
...
public class DevNumericUpDown : NumericUpDown
```

**VB**<br />
``` VB
<ToolboxBitmapAttribute(GetType(NumericUpDown), "NumericUpDown.bmp")>
<ClassInterfaceAttribute(ClassInterfaceType.AutoDispatch)>
<ComVisibleAttribute(true)>
<DefaultBindingPropertyAttribute("Value")>
<DefaultPropertyAttribute("Value")>
<DefaultEventAttribute("ValueChanged")>
Public Class DevNumericUpDown
...
**C++**<br />
``` C++
[ToolboxBitmapAttribute(typeof(NumericUpDown), L"NumericUpDown.bmp")]
[ClassInterfaceAttribute(ClassInterfaceType::AutoDispatch)]
[ComVisibleAttribute(true)]
[DefaultBindingPropertyAttribute(L"Value")]
[DefaultPropertyAttribute(L"Value")]
[DefaultEventAttribute(L"ValueChanged")]
public ref class DevNumericUpDown : public NumericUpDown
```
...
[<DefaultPropertyAttribute("Value")>]
[<DefaultEventAttribute("ValueChanged")>]
type DevNumericUpDown =  
    class
        inherit NumericUpDown
    end
```

The DevNumericUpDown type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_DevCase_Controls_DevNumericUpDown__ctor">DevNumericUpDown</a></td><td>
Initializes a new instance of the DevNumericUpDown class.</td></tr></table>&nbsp;
<a href="#devnumericupdown-class">Back to Top</a>

## Properties
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_DevCase_Controls_DevNumericUpDown_ReadOnly">ReadOnly</a></td><td>
Gets or sets a value indicating whether the control is in read-only mode.</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_DevCase_Controls_DevNumericUpDown_StateDisabled">StateDisabled</a></td><td>
Gets the appearance layout of the control when it is disabled.</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_DevCase_Controls_DevNumericUpDown_StateEnabled">StateEnabled</a></td><td>
Gets the appearance layout of the control when it is enabled.</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_DevCase_Controls_DevNumericUpDown_StateReadOnly">StateReadOnly</a></td><td>

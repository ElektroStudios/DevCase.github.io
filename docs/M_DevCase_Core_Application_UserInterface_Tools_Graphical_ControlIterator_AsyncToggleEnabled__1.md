# ControlIterator.AsyncToggleEnabled(*T*) Method (String)
 

Asynchronously Toggle the enabled state of all the Controls of the specified Type on the active Formulary.
...
returnValue = ControlIterator.AsyncToggleEnabled(containsName)
```

# EnvironmentFolders.CDBurningPath Property 
...
**VB**<br />
``` VB
Public Shared ReadOnly Property CDBurningPath ( 
...
value = EnvironmentFolders.CDBurningPath(folderOption)
...
``` C++
public:
static property String^ CDBurningPath[Environment.SpecialFolderOption folderOption = Environment.SpecialFolderOption::None] {
...
**F#**<br />
``` F#
static member CDBurningPath : string with get
...
#### Property Value
Type: String<br />\[Missing <value> documentation for "P:DevCase.Core.Shell.EnvironmentFolders.CDBurningPath(System.Environment.SpecialFolderOption)"\]

## Examples
This is a code example. 
**VB**<br />
``` VB
Console.WriteLine($"{NameOf(EnvironmentFolders.CDBurningPath)}={EnvironmentFolders.CDBurningPath}")
```

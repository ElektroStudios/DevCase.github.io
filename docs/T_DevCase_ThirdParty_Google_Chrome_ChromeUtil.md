...
Contains Google Chrome related utilities.


## Inheritance Hierarchy
System.Object<br />&nbsp;&nbsp;<a href="T_DevCase_Core_Design_AestheticObject">DevCase.Core.Design.AestheticObject</a><br />&nbsp;&nbsp;&nbsp;&nbsp;DevCase.ThirdParty.Google.Chrome.ChromeUtil<br />
...
**C#**<br />
``` C#
public sealed class ChromeUtil : AestheticObject
```

**VB**<br />
``` VB
Public NotInheritable Class ChromeUtil
	Inherits AestheticObject
```

**VB Usage**<br />
``` VB Usage
Dim instance As ChromeUtil
```

**C++**<br />
``` C++
public ref class ChromeUtil sealed : public AestheticObject
```
...
The ChromeUtil type exposes the following members.
...
<a href="#chromeutil-class">Back to Top</a>
...
#### Reference
<a href="N_DevCase_ThirdParty_Google_Chrome">DevCase.ThirdParty.Google.Chrome Namespace</a><br />
# ControlHintManager Methods
 

The <a href="T_DevCase_Core_Application_UserInterface_Tools_Graphical_ControlHintManager">ControlHintManager</a> type exposes the following members.
...
<a href="#controlhintmanager-methods">Back to Top</a>

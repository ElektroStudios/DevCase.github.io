# WebUtil.PostXmlHttpRequestAsync Method (String, XDocument, Action(HttpWebRequest))
...
Dim result As XDocument =
    Await PostXmlHttpRequestAsync("http://converter.telerik.com/service.asmx", xml,

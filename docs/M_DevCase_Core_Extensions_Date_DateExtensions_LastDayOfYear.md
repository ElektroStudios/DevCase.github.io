# DateExtensions.LastDayOfYear Method 
 

Returns a DateTime representing the last day of the year for the date represented by the specified DateTime.
...
<ExtensionAttribute>
<EditorBrowsableAttribute(EditorBrowsableState.Always)>
Public Shared Function LastDayOfYear ( 
	sender As DateTime
) As DateTime
```
...
returnValue = sender.LastDayOfYear()
```
...
#### Return Value
Type: DateTime<br />A DateTime representing the last day of the year for the date represented by the specified DateTime.

# CommandLineValueParameter(*T*)&nbsp;Implicit Conversion (CommandLineValueParameter(UInt16) to CommandLineValueParameter(*T*))
...
public static implicit operator CommandLineValueParameter<T> (
	CommandLineValueParameter<ushort> cmd
)
```
...
Public Shared Widening Operator CType ( 
	cmd As CommandLineValueParameter(Of UShort)
) As CommandLineValueParameter(Of T)
```

**VB Usage**<br />
``` VB Usage
Dim input As CommandLineValueParameter(Of UShort)
...
static implicit operator CommandLineValueParameter<T>^ (
	CommandLineValueParameter<unsigned short>^ cmd
)
```
...
#### Parameters
&nbsp;<dl><dt>cmd</dt><dd>Type: <a href="T_DevCase_Core_Application_CommandLineValueParameter_1">DevCase.Core.Application.CommandLineValueParameter</a>(UInt16)<br />The <a href="T_DevCase_Core_Application_CommandLineValueParameter_1">CommandLineValueParameter(T)</a> to convert.</dd></dl>

# NativeMethods.PathIsSystemFolder Method (String, FileAttributes)
...
&nbsp;<dl><dt>path</dt><dd>Type: System.String<br />A pointer to a null-terminated string of maximum length MAX_PATH that contains the name of an existing folder. 
 ...
 If this value is NULL, this function determines if the attributes passed in *attributes* qualify it to be a system folder.</dd><dt>attributes</dt><dd>Type: System.IO.FileAttributes<br />The file attributes to be compared. 

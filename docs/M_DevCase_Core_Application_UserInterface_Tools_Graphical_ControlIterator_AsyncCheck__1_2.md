# ControlIterator.AsyncCheck(*T*) Method (Control.ControlCollection, String)
 

Asynchronously Check all the Controls of the specified Type on the specified Control Collection.
...
**C#**<br />
``` C#
public static bool AsyncCheck<T>(
...
**VB**<br />
``` VB
Public Shared Function AsyncCheck(Of T As Control) ( 
...
returnValue = ControlIterator.AsyncCheck(controlCollection, 
	containsName)
```

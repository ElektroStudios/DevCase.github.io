# DevNumericUpDownBorderLayout Class
 

Provides the layout that determines the appearance of the borber of a <a href="T_DevCase_Controls_DevNumericUpDown">DevNumericUpDown</a> control.


## Inheritance Hierarchy
System.Object<br />&nbsp;&nbsp;System.MarshalByRefObject<br />&nbsp;&nbsp;&nbsp;&nbsp;System.ComponentModel.Component<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="T_DevCase_Core_Design_AestheticComponent">DevCase.Core.Design.AestheticComponent</a><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;DevCase.Controls.DevNumericUpDownData.DevNumericUpDownBorderLayout<br />
...
**C#**<br />
``` C#
public sealed class DevNumericUpDownBorderLayout : AestheticComponent
```

**VB**<br />
``` VB
Public NotInheritable Class DevNumericUpDownBorderLayout
...
**C++**<br />
``` C++
public ref class DevNumericUpDownBorderLayout sealed : public AestheticComponent
```

**F#**<br />
``` F#
[<SealedAttribute>]
type DevNumericUpDownBorderLayout =  
    class
        inherit AestheticComponent
    end
```

The DevNumericUpDownBorderLayout type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_DevCase_Controls_DevNumericUpDownData_DevNumericUpDownBorderLayout__ctor">DevNumericUpDownBorderLayout</a></td><td>
Initializes a new instance of the DevNumericUpDownBorderLayout class.</td></tr></table>&nbsp;
<a href="#devnumericupdownborderlayout-class">Back to Top</a>

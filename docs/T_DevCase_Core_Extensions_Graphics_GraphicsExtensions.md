...
Contains custom extension methods to use with an Graphics.


## Inheritance Hierarchy
System.Object<br />&nbsp;&nbsp;DevCase.Core.Extensions.Graphics.GraphicsExtensions<br />
...
public sealed class GraphicsExtensions
```
...
**VB Usage**<br />
``` VB Usage
Dim instance As GraphicsExtensions
```
...
Draws a cross specified by a Point structure, up to the bounds of the source Graphics.</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")![Static member](media/static.gif "Static member")![Code example](media/CodeExample.png "Code example")</td><td><a href="M_DevCase_Core_Extensions_Graphics_GraphicsExtensions_DrawRoundedRectangle">DrawRoundedRectangle</a></td><td>
...
Draws a two-dimensional triangle.</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")![Static member](media/static.gif "Static member")![Code example](media/CodeExample.png "Code example")</td><td><a href="M_DevCase_Core_Extensions_Graphics_GraphicsExtensions_FillRoundedRectangle">FillRoundedRectangle</a></td><td>
Fills the interior of a rounded rectangle.</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")![Static member](media/static.gif "Static member")![Code example](media/CodeExample.png "Code example")</td><td><a href="M_DevCase_Core_Extensions_Graphics_GraphicsExtensions_FillTriangle2D">FillTriangle2D(Graphics, Brush, Vector2, Vector2, Vector2)</a></td><td>
...
<a href="#graphicsextensions-class">Back to Top</a>
...
#### Reference
<a href="N_DevCase_Core_Extensions_Graphics">DevCase.Core.Extensions.Graphics Namespace</a><br />
# StreamExtensions.ReadToEnd Method (Stream, Encoding, Int64)
 

Reads all characters from the specified position to the end of the Stream.
...
#### Parameters
&nbsp;<dl><dt>sender</dt><dd>Type: System.IO.Stream<br />The source Stream.</dd><dt>enc</dt><dd>Type: System.Text.Encoding<br />The encoding.</dd><dt>position</dt><dd>Type: System.Int64<br />The position.</dd></dl>

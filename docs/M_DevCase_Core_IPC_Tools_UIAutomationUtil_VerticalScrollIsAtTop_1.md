# UIAutomationUtil.VerticalScrollIsAtTop Method (IWin32Window)
 

Determines whether the Vertical Scrollbar's scroll of a window is at Top of the Scroll range.
...
returnValue = UIAutomationUtil.VerticalScrollIsAtTop(window)
```

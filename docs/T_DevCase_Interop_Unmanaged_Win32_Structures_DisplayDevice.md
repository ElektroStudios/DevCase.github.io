...
Contains information about the display device specified by the `iDevNum` parameter of the <a href="M_DevCase_Interop_Unmanaged_Win32_NativeMethods_EnumDisplayDevices">EnumDisplayDevices(String, UInt32, DisplayDevice, UInt32)</a> function.
...
**C++**<br />
``` C++
public value class DisplayDevice
```

**F#**<br />
``` F#
[<SealedAttribute>]
type DisplayDevice =  struct end
```
...
## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_DevCase_Interop_Unmanaged_Win32_Structures_DisplayDevice__ctor">DisplayDevice</a></td><td>
Initializes a new instance of the DisplayDevice structure.</td></tr></table>&nbsp;
<a href="#displaydevice-structure">Back to Top</a>

# ListViewDataItemExtensions.CopyItems Method (ListViewDataItem[], String)
...
#### Parameters
&nbsp;<dl><dt>items</dt><dd>Type: ListViewDataItem[]<br />The items to copy.</dd><dt>separator</dt><dd>Type: System.String<br />The string used to separate the text of the subitems.</dd></dl>

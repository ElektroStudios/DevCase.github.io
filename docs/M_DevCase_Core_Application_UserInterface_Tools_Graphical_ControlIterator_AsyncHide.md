# ControlIterator.AsyncHide Method (IEnumerable(Control))
 

Asynchronously Hide multiple Controls at once.
...
returnValue = ControlIterator.AsyncHide(ctrls)
```
...
#### Parameters
&nbsp;<dl><dt>ctrls</dt><dd>Type: System.Collections.Generic.IEnumerable(Control)<br />The controls to hide.</dd></dl>

# NativeMethods.SHGetInstanceExplorer Method (IUnknown)
...
Public Shared Function SHGetInstanceExplorer ( 
	<OutAttribute> ByRef refPunk As IUnknown
) As Integer
```

**VB Usage**<br />
``` VB Usage
Dim refPunk As IUnknown
...
static member SHGetInstanceExplorer : 
        refPunk : IUnknown byref -> int 

```


#### Parameters
&nbsp;<dl><dt>refPunk</dt><dd>Type: IUnknown<br />When this function returns successfully, contains the address of the host process' IUnknown interface pointer. 

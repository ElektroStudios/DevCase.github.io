...
System.Object<br />&nbsp;&nbsp;<a href="T_DevCase_Core_Design_AestheticObject">DevCase.Core.Design.AestheticObject</a><br />&nbsp;&nbsp;&nbsp;&nbsp;DevCase.ThirdParty.VmWare.GuestOsCredential<br />
...
**C#**<br />
``` C#
public sealed class GuestOsCredential : AestheticObject
```
...
**C++**<br />
``` C++
public ref class GuestOsCredential sealed : public AestheticObject
```
...
The GuestOsCredential type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_DevCase_ThirdParty_VmWare_GuestOsCredential__ctor">GuestOsCredential</a></td><td>
Initializes a new instance of the GuestOsCredential class.</td></tr></table>&nbsp;
<a href="#guestoscredential-class">Back to Top</a>

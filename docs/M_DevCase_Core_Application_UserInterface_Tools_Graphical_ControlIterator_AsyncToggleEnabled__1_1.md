# ControlIterator.AsyncToggleEnabled(*T*) Method (Control, String)
 

Asynchronously Toggle the enabled state of all the Controls of the specified Type on the specified Control Container.
...
returnValue = ControlIterator.AsyncToggleEnabled(controlContainer, 
	containsName)
```

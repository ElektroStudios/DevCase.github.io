...
Stores information for the <a href="M_DevCase_Interop_Unmanaged_Win32_NativeMethods_SHOpenWithDialog">SHOpenWithDialog(IntPtr, OpenAsInfo)</a> function.
...
**C++**<br />
``` C++
public value class OpenAsInfo
```

**F#**<br />
``` F#
[<SealedAttribute>]
type OpenAsInfo =  struct end
```

The OpenAsInfo type exposes the following members.
...
<a href="#openasinfo-structure">Back to Top</a>

# EnvironmentFolders.AdminToolsPath Property 
...
**VB**<br />
``` VB
Public Shared ReadOnly Property AdminToolsPath ( 
...
value = EnvironmentFolders.AdminToolsPath(folderOption)
...
``` C++
public:
static property String^ AdminToolsPath[Environment.SpecialFolderOption folderOption = Environment.SpecialFolderOption::None] {
...
**F#**<br />
``` F#
static member AdminToolsPath : string with get
...
#### Property Value
Type: String<br />\[Missing <value> documentation for "P:DevCase.Core.Shell.EnvironmentFolders.AdminToolsPath(System.Environment.SpecialFolderOption)"\]

## Examples
This is a code example. 
**VB**<br />
``` VB
Console.WriteLine($"{NameOf(EnvironmentFolders.AdminToolsPath)}={EnvironmentFolders.AdminToolsPath}")
```

# MailUtil.SendMailHtml Method (SmtpClient, NetworkCredential, String, String, String)
...
Dim body As String
Dim address As StringMailUtil.SendMailHtml(smtpClient, credential, 
...
SendMailHtml(DevCase.Core.NET.SmtpClients.MicrosoftLiveSmtpClient, credential, "Email Subject", "Message Body", "address@domain.com")
```

# ControlIterator.AsyncToggleChecked(*T*) Method (String)
 

Asynchronously Toggle the checked state of all the Controls of the specified Type on the active Formulary.
...
returnValue = ControlIterator.AsyncToggleChecked(containsName)
```

# ControlIterator.AsyncUncheck(*T*) Method (Control.ControlCollection, String)
 

Asynchronously Uncheck all the Controls of the specified Type on the specified Control Collection.
...
**C#**<br />
``` C#
public static bool AsyncUncheck<T>(
...
**VB**<br />
``` VB
Public Shared Function AsyncUncheck(Of T As Control) ( 
...
returnValue = ControlIterator.AsyncUncheck(controlCollection, 
	containsName)
```

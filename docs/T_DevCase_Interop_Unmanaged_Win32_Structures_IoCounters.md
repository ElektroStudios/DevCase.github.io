...
Contains I/O accounting information for a process or a job object. 
 ...
 For a job object, the counters include all operations performed by all processes that have ever been associated with the job, in addition to all processes currently associated with the job.
...
**C++**<br />
``` C++
public value class IoCounters
```

**F#**<br />
``` F#
[<SealedAttribute>]
type IoCounters =  struct end
```
...
<a href="#iocounters-structure">Back to Top</a>
...
## Remarks
<a href="https://docs.microsoft.com/en-us/windows/desktop/api/winnt/ns-winnt-_io_counters" target="_blank">https://docs.microsoft.com/en-us/windows/desktop/api/winnt/ns-winnt-_io_counters</a>

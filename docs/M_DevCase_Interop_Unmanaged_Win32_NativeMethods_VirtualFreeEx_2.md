# NativeMethods.VirtualFreeEx Method (IntPtr, UIntPtr, UIntPtr, MemoryFreeType)
...
&nbsp;<dl><dt>process</dt><dd>Type: System.IntPtr<br />A handle to a process. The function frees memory within the virtual address space of the process. 
 ...
 The handle must have the <a href="T_DevCase_Interop_Unmanaged_Win32_Enums_ProcessAccessRights">VirtualMemoryOperation</a> access right.</dd><dt>address</dt><dd>Type: System.UIntPtr<br />A pointer to the starting address of the region of memory to be freed. 

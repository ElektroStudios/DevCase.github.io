...
System.Object<br />&nbsp;&nbsp;<a href="T_DevCase_Core_Design_AestheticObject">DevCase.Core.Design.AestheticObject</a><br />&nbsp;&nbsp;&nbsp;&nbsp;DevCase.Core.Text.Tools.StringUtil.WordLists<br />
...
**C#**<br />
``` C#
public sealed class WordLists : AestheticObject
```

**VB**<br />
``` VB
Public NotInheritable Class WordLists
	Inherits AestheticObject
```

**VB Usage**<br />
``` VB Usage
Dim instance As StringUtil.WordLists
```

**C++**<br />
``` C++
public ref class WordLists sealed : public AestheticObject
```
...
The StringUtil.WordLists type exposes the following members.
...
<a href="#stringutil.wordlists-class">Back to Top</a>

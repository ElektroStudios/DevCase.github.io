# ControlIterator.AsyncEnable(*T*) Method (Control.ControlCollection, String)
 

Asynchronously Enable all the Controls of the specified Type on the specified Control Collection.
...
**VB**<br />
``` VB
Public Function AsyncEnable(Of T As Control) ( 
...
returnValue = instance.AsyncEnable(controlCollection, 
	containsName)
```

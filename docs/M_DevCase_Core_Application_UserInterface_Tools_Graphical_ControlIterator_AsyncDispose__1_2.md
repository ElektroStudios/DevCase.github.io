# ControlIterator.AsyncDispose(*T*) Method (Control.ControlCollection, String)
 

Asynchronously Dispose all the Controls of the specified Type on the specified Control Collection.
...
returnValue = ControlIterator.AsyncDispose(controlCollection, 
	containsName)
```

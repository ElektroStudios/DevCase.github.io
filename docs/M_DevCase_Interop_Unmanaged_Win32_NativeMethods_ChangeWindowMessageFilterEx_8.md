# NativeMethods.ChangeWindowMessageFilterEx Method (SafeHandle, ListBoxMessages, ChangeWindowMessageFilterExAction, ChangeFilter)
 

Modifies the `User Interface Privilege Isolation` (`UIPI`) message filter for a specified ListBox control.

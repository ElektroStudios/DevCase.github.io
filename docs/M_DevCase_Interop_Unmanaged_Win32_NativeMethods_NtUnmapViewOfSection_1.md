# NativeMethods.NtUnmapViewOfSection Method (IntPtr, IntPtr)
...
#### Parameters
&nbsp;<dl><dt>hProcess</dt><dd>Type: System.IntPtr<br />Handle to a process object that was previously passed to <a href="M_DevCase_Interop_Unmanaged_Win32_NativeMethods_NtMapViewOfSection">NtMapViewOfSection(IntPtr, SafeProcessHandle, IntPtr, IntPtr, IntPtr, Int64, UIntPtr, SectionInherit, MemoryAllocationType, MemoryProtectionOptions)</a>.</dd><dt>address</dt><dd>Type: System.IntPtr<br />Pointer to the base virtual address of the view to unmap. 

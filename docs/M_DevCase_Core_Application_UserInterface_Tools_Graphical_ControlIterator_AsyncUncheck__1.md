# ControlIterator.AsyncUncheck(*T*) Method (String)
 

Asynchronously Uncheck all the Controls of the specified Type on the active Formulary.
...
returnValue = ControlIterator.AsyncUncheck(containsName)
```

# EnumFlagsEditor(*TEnum*) Methods
 

The <a href="T_DevCase_Core_Design_EnumFlagsEditor_1">EnumFlagsEditor(TEnum)</a> generic type exposes the following members.
...
<a href="#enumflagseditor(*tenum*)-methods">Back to Top</a>

# ControlIterator.AsyncShow(*T*) Method (Control.ControlCollection, String)
 

Asynchronously Show all the Controls of the specified Type on the specified Control Collection.
...
**C#**<br />
``` C#
public static bool AsyncShow<T>(
...
**VB**<br />
``` VB
Public Shared Function AsyncShow(Of T As Control) ( 
...
returnValue = ControlIterator.AsyncShow(controlCollection, 
	containsName)
```

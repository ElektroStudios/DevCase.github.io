...
Contains custom extension methods to use with the EventHandler type.


## Inheritance Hierarchy
System.Object<br />&nbsp;&nbsp;DevCase.Core.Extensions.EventHandler.EventHandlerExtensions<br />
...
public sealed class EventHandlerExtensions
```
...
<ExtensionAttribute>
<HideModuleNameAttribute>
Public NotInheritable Class EventHandlerExtensions
```

**VB Usage**<br />
``` VB Usage
Dim instance As EventHandlerExtensions
```
...
[ExtensionAttribute]
[HideModuleNameAttribute]
public ref class EventHandlerExtensions sealed
```
...
[<ExtensionAttribute>]
[<HideModuleNameAttribute>]
type EventHandlerExtensions =  class end
```

The EventHandlerExtensions type exposes the following members.
...
<a href="#eventhandlerextensions-class">Back to Top</a>
...
#### Reference
<a href="N_DevCase_Core_Extensions_EventHandler">DevCase.Core.Extensions.EventHandler Namespace</a><br />
...
**C++**<br />
``` C++
public value class Luid
```

**F#**<br />
``` F#
[<SealedAttribute>]
type Luid =  struct end
```
...
<a href="#luid-structure">Back to Top</a>
...
## Remarks
<a href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa379261%28v=vs.85%29.aspx" target="_blank">https://msdn.microsoft.com/en-us/library/windows/desktop/aa379261%28v=vs.85%29.aspx</a>

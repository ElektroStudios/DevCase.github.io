# MailUtil.SendMailHtml Method (SmtpClient, NetworkCredential, String, String, String[], ICollection(Attachment))
...
SendMailHtml(DevCase.Core.NET.SmtpClients.MicrosoftLiveSmtpClient, credential, "Email Subject", "Message Body", {"address1@domain.com", "address2@domain.com"}, attachments)
```

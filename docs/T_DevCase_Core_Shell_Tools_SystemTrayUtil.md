# SystemTrayUtil Class
 

Contains System-Tray related utilities.


## Inheritance Hierarchy
System.Object<br />&nbsp;&nbsp;<a href="T_DevCase_Core_Design_AestheticObject">DevCase.Core.Design.AestheticObject</a><br />&nbsp;&nbsp;&nbsp;&nbsp;DevCase.Core.Shell.Tools.SystemTrayUtil<br />
...
**C#**<br />
``` C#
public sealed class SystemTrayUtil : AestheticObject
```

**VB**<br />
``` VB
Public NotInheritable Class SystemTrayUtil
	Inherits AestheticObject
```

**VB Usage**<br />
``` VB Usage
Dim instance As SystemTrayUtil
```

**C++**<br />
``` C++
public ref class SystemTrayUtil sealed : public AestheticObject
```
...
The SystemTrayUtil type exposes the following members.
...
<a href="#systemtrayutil-class">Back to Top</a>

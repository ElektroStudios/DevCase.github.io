...
Searches for all the elements in the source three-dimensional array that matches the conditions defined by the specified predicate.
...
#### Return Value
Type: IEnumerable(*T*)<br />All the elements in the source three-dimensional array that matches the conditions defined by the specified predicate.

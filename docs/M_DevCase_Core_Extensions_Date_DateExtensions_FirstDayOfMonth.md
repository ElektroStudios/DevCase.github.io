# DateExtensions.FirstDayOfMonth Method 
 

Returns a DateTime representing the first day of the month for the date represented by the specified DateTime.
...
<ExtensionAttribute>
<EditorBrowsableAttribute(EditorBrowsableState.Always)>
Public Shared Function FirstDayOfMonth ( 
	sender As DateTime
) As DateTime
```
...
returnValue = sender.FirstDayOfMonth()
```
...
#### Return Value
Type: DateTime<br />A DateTime representing the first day of the month for the date represented by the specified DateTime.

...
## Overload List
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public property](media/pubproperty.gif "Public property")![Static member](media/static.gif "Static member")</td><td><a href="P_DevCase_Core_Shell_Tools_VolumeUtil_IsReadOnly">IsReadOnly</a></td><td>
...
Gets a value that determines whether the specified volume is a read only volume.</td></tr></table>&nbsp;
<a href="#volumeutil.isreadonly-property">Back to Top</a>

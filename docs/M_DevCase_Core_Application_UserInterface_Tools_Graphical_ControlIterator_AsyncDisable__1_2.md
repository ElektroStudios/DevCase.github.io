# ControlIterator.AsyncDisable(*T*) Method (Control.ControlCollection, String)
 

Asynchronously Disable all the Controls of the specified Type on the specified Control Collection.
...
returnValue = ControlIterator.AsyncDisable(controlCollection, 
	containsName)
```

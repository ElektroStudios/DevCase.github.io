# EnvironmentFolders.DesktopPath Property 
...
**VB**<br />
``` VB
Public Shared ReadOnly Property DesktopPath ( 
...
value = EnvironmentFolders.DesktopPath(folderOption)
...
``` C++
public:
static property String^ DesktopPath[Environment.SpecialFolderOption folderOption = Environment.SpecialFolderOption::None] {
...
**F#**<br />
``` F#
static member DesktopPath : string with get
...
#### Property Value
Type: String<br />\[Missing <value> documentation for "P:DevCase.Core.Shell.EnvironmentFolders.DesktopPath(System.Environment.SpecialFolderOption)"\]

## Examples
This is a code example. 
**VB**<br />
``` VB
Console.WriteLine($"{NameOf(EnvironmentFolders.DesktopPath)}={EnvironmentFolders.DesktopPath}")
```

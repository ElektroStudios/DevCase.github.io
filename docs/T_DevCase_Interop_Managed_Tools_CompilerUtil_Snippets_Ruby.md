# CompilerUtil.Snippets.Ruby Class
 

Contains predefined snippets and source-code templates for `Ruby` scripting language.


## Inheritance Hierarchy
System.Object<br />&nbsp;&nbsp;DevCase.Interop.Managed.Tools.CompilerUtil.Snippets.Ruby<br />
...
**C#**<br />
``` C#
public sealed class Ruby
```

**VB**<br />
``` VB
Public NotInheritable Class Ruby
```

**VB Usage**<br />
``` VB Usage
Dim instance As CompilerUtil.Snippets.Ruby
```

**C++**<br />
``` C++
public ref class Ruby sealed
```
...
The CompilerUtil.Snippets.Ruby type exposes the following members.
...
<a href="#compilerutil.snippets.ruby-class">Back to Top</a>

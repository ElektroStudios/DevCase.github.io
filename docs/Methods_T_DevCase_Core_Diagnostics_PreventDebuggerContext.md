# PreventDebuggerContext Methods
 

The <a href="T_DevCase_Core_Diagnostics_PreventDebuggerContext">PreventDebuggerContext</a> type exposes the following members.
...
<a href="#preventdebuggercontext-methods">Back to Top</a>

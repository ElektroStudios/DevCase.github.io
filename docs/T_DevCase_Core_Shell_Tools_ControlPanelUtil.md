# ControlPanelUtil Class
 

Contains Control Panel related utilities.


## Inheritance Hierarchy
System.Object<br />&nbsp;&nbsp;<a href="T_DevCase_Core_Design_AestheticObject">DevCase.Core.Design.AestheticObject</a><br />&nbsp;&nbsp;&nbsp;&nbsp;DevCase.Core.Shell.Tools.ControlPanelUtil<br />
...
**C#**<br />
``` C#
public sealed class ControlPanelUtil : AestheticObject
```
...
**VB Usage**<br />
``` VB Usage
Dim instance As ControlPanelUtil
```

**C++**<br />
``` C++
public ref class ControlPanelUtil sealed : public AestheticObject
```

**F#**<br />
``` F#
[<SealedAttribute>]
type ControlPanelUtil =  
    class
        inherit AestheticObject
    end
```

The ControlPanelUtil type exposes the following members.
...
<a href="#controlpanelutil-class">Back to Top</a>

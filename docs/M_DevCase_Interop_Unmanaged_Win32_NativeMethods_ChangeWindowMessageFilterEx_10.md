# NativeMethods.ChangeWindowMessageFilterEx Method (SafeHandle, ProgressBarMessages, ChangeWindowMessageFilterExAction, ChangeFilter)
 

Modifies the `User Interface Privilege Isolation` (`UIPI`) message filter for a specified ProgressBar control.

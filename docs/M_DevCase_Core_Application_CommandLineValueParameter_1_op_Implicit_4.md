# CommandLineValueParameter(*T*)&nbsp;Implicit Conversion (CommandLineValueParameter(Decimal) to CommandLineValueParameter(*T*))
...
#### Parameters
&nbsp;<dl><dt>cmd</dt><dd>Type: <a href="T_DevCase_Core_Application_CommandLineValueParameter_1">DevCase.Core.Application.CommandLineValueParameter</a>(Decimal)<br />The <a href="T_DevCase_Core_Application_CommandLineValueParameter_1">CommandLineValueParameter(T)</a> to convert.</dd></dl>

# EnvironmentFolders.CookiesPath Property 
...
**VB**<br />
``` VB
Public Shared ReadOnly Property CookiesPath ( 
...
value = EnvironmentFolders.CookiesPath(folderOption)
...
``` C++
public:
static property String^ CookiesPath[Environment.SpecialFolderOption folderOption = Environment.SpecialFolderOption::None] {
...
**F#**<br />
``` F#
static member CookiesPath : string with get
...
#### Property Value
Type: String<br />\[Missing <value> documentation for "P:DevCase.Core.Shell.EnvironmentFolders.CookiesPath(System.Environment.SpecialFolderOption)"\]

## Examples
This is a code example. 
**VB**<br />
``` VB
Console.WriteLine($"{NameOf(EnvironmentFolders.CookiesPath)}={EnvironmentFolders.CookiesPath}")
```

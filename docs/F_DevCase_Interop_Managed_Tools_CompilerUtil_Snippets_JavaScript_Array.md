# CompilerUtil.Snippets.JavaScript.Array Field
 

A snippet of an `Array` initialization example written in `JavaScript`.
...
value = CompilerUtil.Snippets.JavaScript.Array

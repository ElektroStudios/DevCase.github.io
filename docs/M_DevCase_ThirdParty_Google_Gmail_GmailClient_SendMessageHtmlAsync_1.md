# GmailClient.SendMessageHtmlAsync Method (String, String, MailAddress, ICollection(Attachment))
...
#### Return Value
Type: Task(String)<br />\[Missing <returns> documentation for "M:DevCase.ThirdParty.Google.Gmail.GmailClient.SendMessageHtmlAsync(System.String,System.String,System.Net.Mail.MailAddress,System.Collections.Generic.ICollection{System.Net.Mail.Attachment})"\]
...
Await SendMessageHtmlAsync("Email Subject", "Message Body", New MailAddress("address@domain.com"), attachments)
```

...
**C#**<br />
``` C#
public class ScreenRegionSelector : AestheticForm
```
...
**C++**<br />
``` C++
public ref class ScreenRegionSelector : public AestheticForm
```

**F#**<br />
``` F#
type ScreenRegionSelector =  
    class
        inherit AestheticForm
    end
```

The ScreenRegionSelector type exposes the following members.
...
Initializes a new instance of the ScreenRegionSelector class.</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_DevCase_Core_Imaging_ScreenRegionSelector__ctor_1">ScreenRegionSelector(Color, Int32, Color, Double)</a></td><td>
Initializes a new instance of the ScreenRegionSelector class.</td></tr></table>&nbsp;
<a href="#screenregionselector-class">Back to Top</a>
...
Public Class Form1
    ...
    Friend WithEvents ScrSelector As New ScreenRegionSelector With
        {
            .BorderColor = Color.GreenYellow,
            .BorderSize = 2,
            .BackgroundColor = Color.YellowGreen,
            .BackgroundOpacity = 0.04R
        }
    ...
    Private Sub ScrSelector_RegionSelected(ByVal sender As Object, ByVal e As RegionSelectedEventArgs) _
    Handles ScrSelector.RegionSelected
        ...
        With sb
            ...
            .AppendLine()
            .AppendLine("[+] Size")
            .AppendLine(String.Format("Width: {0}", CStr(e.Region.Width)))
            .AppendLine(String.Format("Height: {0}", CStr(e.Region.Height)))
            .AppendLine()
            .AppendLine("[+] Coordinates")
            .AppendLine(String.Format("Top: {0}", CStr(e.Region.Top)))
            .AppendLine(String.Format("Left: {0}", CStr(e.Region.Left)))
            .AppendLine(String.Format("Right: {0}", CStr(e.Region.Right)))
            .AppendLine(String.Format("Bottom: {0}", CStr(e.Region.Bottom)))
            .AppendLine()
        End With

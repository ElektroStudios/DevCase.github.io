...
Represents the Dash (symbol: DASH) cryptocurrency.


## Inheritance Hierarchy
System.Object<br />&nbsp;&nbsp;DevCase.Core.NET.CryptoCurrencies.Dash<br />
...
**C#**<br />
``` C#
public class Dash : ICryptoCurrency
```
...
**C++**<br />
``` C++
public ref class Dash : ICryptoCurrency
```
...
## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_DevCase_Core_NET_CryptoCurrencies_Dash__ctor">Dash</a></td><td>
Initializes a new instance of the Dash class.</td></tr></table>&nbsp;
<a href="#dash-class">Back to Top</a>
...
Gets the canonical name of the Dash cryptocurrency.</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_DevCase_Core_NET_CryptoCurrencies_Dash_Symbol">Symbol</a></td><td>
...
Gets the price for the specified amount of Dashes converted to the specified currency.</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_DevCase_Core_NET_CryptoCurrencies_Dash_GetPriceAsync">GetPriceAsync(Currencies)</a></td><td>

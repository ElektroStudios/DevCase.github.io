...
Releases all the resources used by this <a href="T_DevCase_Core_IO_PrintDocumentBasic">PrintDocumentBasic</a> instance.</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_DevCase_Core_IO_PrintDocumentBasic_Print">Print</a></td><td>
Prints the current document.</td></tr></table>&nbsp;
<a href="#printdocumentbasic-methods">Back to Top</a>

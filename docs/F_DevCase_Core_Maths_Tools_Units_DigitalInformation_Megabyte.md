# Units.DigitalInformation.Megabyte Field
 

A megabyte (symbol: MB) is a unit of digital information equals to 1024 kilobytes.
...
**C#**<br />
``` C#
public static readonly Unit Megabyte
```

**VB**<br />
``` VB
Public Shared ReadOnly Megabyte As Unit
```
...
value = Units.DigitalInformation.Megabyte
...
``` C++
public:
static initonly Unit^ Megabyte
```

**F#**<br />
``` F#
static val Megabyte: Unit
```

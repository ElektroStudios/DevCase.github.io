# ControlIterator.Check(*T*) Method (Control.ControlCollection, String)
...
**VB**<br />
``` VB
Public Shared Function Check(Of T As Control) ( 
...
returnValue = ControlIterator.Check(controlCollection, 
	containsName)
```

# IEnumerableExtensions.Prepend(*T*) Method 
...
returnValue = sender.Prepend(item)
```
...
#### Parameters
&nbsp;<dl><dt>sender</dt><dd>Type: System.Collections.Generic.IEnumerable(*T*)<br />The source IEnumerable(T).</dd><dt>item</dt><dd>Type: *T*<br />The element to prepend.</dd></dl>

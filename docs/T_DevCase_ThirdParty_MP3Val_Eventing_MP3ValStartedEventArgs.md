# MP3ValStartedEventArgs Class
 

Contains the event data of a <a href="E_DevCase_ThirdParty_MP3Val_MP3ValWrapper_Started">Started</a> event.


## Inheritance Hierarchy
System.Object<br />&nbsp;&nbsp;System.EventArgs<br />&nbsp;&nbsp;&nbsp;&nbsp;<a href="T_DevCase_Core_Design_AestheticEventArgs">DevCase.Core.Design.AestheticEventArgs</a><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;DevCase.ThirdParty.MP3Val.Eventing.MP3ValStartedEventArgs<br />
...
**C#**<br />
``` C#
public sealed class MP3ValStartedEventArgs : AestheticEventArgs
```

**VB**<br />
``` VB
Public NotInheritable Class MP3ValStartedEventArgs
...
**C++**<br />
``` C++
public ref class MP3ValStartedEventArgs sealed : public AestheticEventArgs
```

**F#**<br />
``` F#
[<SealedAttribute>]
type MP3ValStartedEventArgs =  
    class
        inherit AestheticEventArgs
    end
```

The MP3ValStartedEventArgs type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_DevCase_ThirdParty_MP3Val_Eventing_MP3ValStartedEventArgs__ctor">MP3ValStartedEventArgs</a></td><td>
Initializes a new instance of the MP3ValStartedEventArgs class.</td></tr></table>&nbsp;
<a href="#mp3valstartedeventargs-class">Back to Top</a>

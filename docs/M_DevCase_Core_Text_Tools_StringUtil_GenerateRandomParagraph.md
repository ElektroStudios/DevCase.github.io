# StringUtil.GenerateRandomParagraph Method 
...
**VB**<br />
``` VB
Public Shared Function GenerateRandomParagraph ( 
	words As String(),
...
returnValue = StringUtil.GenerateRandomParagraph(words, 
	numberOfParagraphs, htmlFormatting)
```
...
**F#**<br />
``` F#
static member GenerateRandomParagraph : 
        words : string[] * 
...
#### Parameters
&nbsp;<dl><dt>words</dt><dd>Type: System.String[]<br />The words that will be used to build paragraphs.</dd><dt>numberOfParagraphs</dt><dd>Type: System.Int32<br />The number of paragraphs to generate.</dd><dt>htmlFormatting</dt><dd>Type: System.Boolean<br />Specifies whether or not to format paragraphs for HTML.</dd></dl>

#### Return Value
Type: String<br />The resulting paragraph(s).

...
**VB**<br />
``` VB
Public Structure ConsoleCoordinate
```
...
**C++**<br />
``` C++
public value class ConsoleCoordinate
```

**F#**<br />
``` F#
[<SealedAttribute>]
type ConsoleCoordinate =  struct end
```

The ConsoleCoordinate type exposes the following members.
...
<a href="#consolecoordinate-structure">Back to Top</a>
...
## Remarks
<a href="https://docs.microsoft.com/en-us/windows/console/coord-str" target="_blank">https://docs.microsoft.com/en-us/windows/console/coord-str</a>

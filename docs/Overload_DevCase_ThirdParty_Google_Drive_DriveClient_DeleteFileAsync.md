# DriveClient.DeleteFileAsync Method 
 


## Overload List
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")![Code example](media/CodeExample.png "Code example")</td><td><a href="M_DevCase_ThirdParty_Google_Drive_DriveClient_DeleteFileAsync">DeleteFileAsync(File)</a></td><td>
...
Asynchronously permanently deletes a existing file from the Google Drive of the user account.</td></tr></table>&nbsp;
<a href="#driveclient.deletefileasync-method">Back to Top</a>

# GmailClient.SendMessageText Method (String, String, String, ICollection(Attachment))
...
SendMessageText("Email Subject", "Message Body", "address@domain.com", attachments)
```

...
Performs the specified action on each element of the specified four-dimensional array.
...
#### Parameters
&nbsp;<dl><dt>array</dt><dd>Type: *T*[,]<br />The source four-dimensional array.</dd><dt>action</dt><dd>Type: System.Action(*T*)<br />The Action to perform on each element of the four-dimensional array.</dd></dl>

# CommandLineValueParameter(*T*)&nbsp;Implicit Conversion (CommandLineValueParameter(Boolean) to CommandLineValueParameter(*T*))
...
public static implicit operator CommandLineValueParameter<T> (
	CommandLineValueParameter<bool> cmd
)
```
...
Public Shared Widening Operator CType ( 
	cmd As CommandLineValueParameter(Of Boolean)
) As CommandLineValueParameter(Of T)
```

**VB Usage**<br />
``` VB Usage
Dim input As CommandLineValueParameter(Of Boolean)
...
#### Parameters
&nbsp;<dl><dt>cmd</dt><dd>Type: <a href="T_DevCase_Core_Application_CommandLineValueParameter_1">DevCase.Core.Application.CommandLineValueParameter</a>(Boolean)<br />The <a href="T_DevCase_Core_Application_CommandLineValueParameter_1">CommandLineValueParameter(T)</a> to convert.</dd></dl>

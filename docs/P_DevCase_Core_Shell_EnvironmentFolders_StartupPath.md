# EnvironmentFolders.StartupPath Property 
...
**VB**<br />
``` VB
Public Shared ReadOnly Property StartupPath ( 
...
value = EnvironmentFolders.StartupPath(folderOption)
...
``` C++
public:
static property String^ StartupPath[Environment.SpecialFolderOption folderOption = Environment.SpecialFolderOption::None] {
...
#### Property Value
Type: String<br />\[Missing <value> documentation for "P:DevCase.Core.Shell.EnvironmentFolders.StartupPath(System.Environment.SpecialFolderOption)"\]

## Examples
This is a code example. 
**VB**<br />
``` VB
Console.WriteLine($"{NameOf(EnvironmentFolders.StartupPath)}={EnvironmentFolders.StartupPath}")
```

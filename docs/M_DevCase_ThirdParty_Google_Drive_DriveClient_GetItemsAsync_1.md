# DriveClient.GetItemsAsync Method (Func(File, Boolean))
 

Asynchronously gets the files and folders stored in the current user account that matches the specified search criteria.
...
returnValue = instance.GetItemsAsync(predicate)
```
...
#### Parameters
&nbsp;<dl><dt>predicate</dt><dd>Type: System.Func(File, Boolean)<br />\[Missing <param name="predicate"/> documentation for "M:DevCase.ThirdParty.Google.Drive.DriveClient.GetItemsAsync(System.Func{Google.Apis.Drive.v3.Data.File,System.Boolean})"\]</dd></dl>
...
Dim items As List(Of Google.Apis.Drive.v3.Data.File) = Await client.GetItemsAsync(predicate)

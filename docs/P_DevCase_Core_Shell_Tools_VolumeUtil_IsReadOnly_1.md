# VolumeUtil.IsReadOnly Property (String)
 

Gets a value that determines whether the specified volume is a read only volume.
...
**VB**<br />
``` VB
Public Shared ReadOnly Property IsReadOnly ( 
...
value = VolumeUtil.IsReadOnly(rootPathName)
...
``` C++
public:
static property bool IsReadOnly[String^ rootPathName] {

# SharedMemoryUtil.ReadCharAt Method 
...
Reads a character from a position of an existing MemoryMappedFile.</td></tr></table>&nbsp;
<a href="#sharedmemoryutil.readcharat-method">Back to Top</a>

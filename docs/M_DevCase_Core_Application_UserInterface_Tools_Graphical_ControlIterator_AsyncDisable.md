# ControlIterator.AsyncDisable Method (IEnumerable(Control))
 

Asynchronously Disable multiple Controls at once.
...
returnValue = ControlIterator.AsyncDisable(ctrls)
```
...
#### Parameters
&nbsp;<dl><dt>ctrls</dt><dd>Type: System.Collections.Generic.IEnumerable(Control)<br />The controls to disable.</dd></dl>

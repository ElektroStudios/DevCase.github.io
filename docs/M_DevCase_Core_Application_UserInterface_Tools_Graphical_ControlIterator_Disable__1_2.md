# ControlIterator.Disable(*T*) Method (Control.ControlCollection, String)
...
**VB**<br />
``` VB
Public Shared Function Disable(Of T As Control) ( 
...
returnValue = ControlIterator.Disable(controlCollection, 
	containsName)
```

...
Contains XnaFan related utilities.


## Inheritance Hierarchy
System.Object<br />&nbsp;&nbsp;<a href="T_DevCase_Core_Design_AestheticObject">DevCase.Core.Design.AestheticObject</a><br />&nbsp;&nbsp;&nbsp;&nbsp;DevCase.ThirdParty.XnaFan.XnaFanUtil<br />
...
**C#**<br />
``` C#
public sealed class XnaFanUtil : AestheticObject
```

**VB**<br />
``` VB
Public NotInheritable Class XnaFanUtil
	Inherits AestheticObject
```

**VB Usage**<br />
``` VB Usage
Dim instance As XnaFanUtil
```

**C++**<br />
``` C++
public ref class XnaFanUtil sealed : public AestheticObject
```
...
The XnaFanUtil type exposes the following members.
...
<a href="#xnafanutil-class">Back to Top</a>
...
#### Reference
<a href="N_DevCase_ThirdParty_XnaFan">DevCase.ThirdParty.XnaFan Namespace</a><br />
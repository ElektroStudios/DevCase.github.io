...
Gets the price for the specified amount of Ripples converted to the specified currency.</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_DevCase_Core_NET_CryptoCurrencies_Ripple_GetPriceAsync">GetPriceAsync(Currencies)</a></td><td>
...
<a href="#ripple-methods">Back to Top</a>

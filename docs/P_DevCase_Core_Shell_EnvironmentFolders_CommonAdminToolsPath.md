# EnvironmentFolders.CommonAdminToolsPath Property 
...
**VB**<br />
``` VB
Public Shared ReadOnly Property CommonAdminToolsPath ( 
...
value = EnvironmentFolders.CommonAdminToolsPath(folderOption)
...
``` C++
public:
static property String^ CommonAdminToolsPath[Environment.SpecialFolderOption folderOption = Environment.SpecialFolderOption::None] {
...
**F#**<br />
``` F#
static member CommonAdminToolsPath : string with get
...
#### Property Value
Type: String<br />\[Missing <value> documentation for "P:DevCase.Core.Shell.EnvironmentFolders.CommonAdminToolsPath(System.Environment.SpecialFolderOption)"\]

## Examples
This is a code example. 
**VB**<br />
``` VB
Console.WriteLine($"{NameOf(EnvironmentFolders.CommonAdminToolsPath)}={EnvironmentFolders.CommonAdminToolsPath}")
```

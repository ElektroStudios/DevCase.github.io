# DevLEDLabelMulti.ColorBackground Property 
...
public override Color ColorBackground { get; set; }
```
...
Public Overrides Property ColorBackground As Color
	Get
	Set
```
...
value = instance.ColorBackground

instance.ColorBackground = value
```
...
virtual property Color ColorBackground {
	Color get () override;
...
[<DesignerSerializationVisibilityAttribute(DesignerSerializationVisibility.Visible)>]
[<DefaultValueAttribute(typeof(Color), "Black")>]
abstract ColorBackground : Color with get, set
[<BrowsableAttribute(true)>]
[<EditorBrowsableAttribute(EditorBrowsableState.Always)>]
[<DesignerSerializationVisibilityAttribute(DesignerSerializationVisibility.Visible)>]
[<DefaultValueAttribute(typeof(Color), "Black")>]
override ColorBackground : Color with get, set
```

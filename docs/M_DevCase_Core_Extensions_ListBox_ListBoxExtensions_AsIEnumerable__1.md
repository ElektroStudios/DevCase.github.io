# ListBoxExtensions.AsIEnumerable(*T*) Method (ListBox.ObjectCollection)
...
static member AsIEnumerable : 
        sender : ListBox.ObjectCollection -> IEnumerable<'T> 
...
#### Type Parameters
&nbsp;<dl><dt>T</dt><dd>\[Missing <typeparam name="T"/> documentation for "M:DevCase.Core.Extensions.ListBox.ListBoxExtensions.AsIEnumerable``1(System.Windows.Forms.ListBox.ObjectCollection)"\]</dd></dl>

# ControlIterator.AsyncHide(*T*) Method (Control.ControlCollection, String)
 

Asynchronously Hide all the Controls of the specified Type on the specified Control Collection.
...
**C#**<br />
``` C#
public static bool AsyncHide<T>(
...
**VB**<br />
``` VB
Public Shared Function AsyncHide(Of T As Control) ( 
...
returnValue = ControlIterator.AsyncHide(controlCollection, 
	containsName)
```

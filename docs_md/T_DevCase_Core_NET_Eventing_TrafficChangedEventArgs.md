# TrafficChangedEventArgs Class
 

Contains the event data for the <a href="E_DevCase_Core_NET_NetworkTrafficMonitor_TrafficChanged">TrafficChanged</a> event.


## Inheritance Hierarchy
System.Object<br />&nbsp;&nbsp;System.EventArgs<br />&nbsp;&nbsp;&nbsp;&nbsp;<a href="T_DevCase_Core_Design_AestheticEventArgs">DevCase.Core.Design.AestheticEventArgs</a><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;DevCase.Core.NET.Eventing.TrafficChangedEventArgs<br />
...
**C#**<br />
``` C#
public sealed class TrafficChangedEventArgs : AestheticEventArgs
```

**VB**<br />
``` VB
Public NotInheritable Class TrafficChangedEventArgs
...
**C++**<br />
``` C++
public ref class TrafficChangedEventArgs sealed : public AestheticEventArgs
```

**F#**<br />
``` F#
[<SealedAttribute>]
type TrafficChangedEventArgs =  
    class
        inherit AestheticEventArgs
    end
```

The TrafficChangedEventArgs type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_DevCase_Core_NET_Eventing_TrafficChangedEventArgs__ctor">TrafficChangedEventArgs</a></td><td>
Initializes a new instance of the TrafficChangedEventArgs class.</td></tr></table>&nbsp;
<a href="#trafficchangedeventargs-class">Back to Top</a>

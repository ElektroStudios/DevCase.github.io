...
public class DevImageComboBox : DevComboBox
```
...
<DefaultPropertyAttribute("Items")>
<DefaultEventAttribute("SelectedIndexChanged")>
Public Class DevImageComboBox
	Inherits DevComboBox
```
...
public ref class DevImageComboBox : public DevComboBox
```
...
[<DefaultPropertyAttribute("Items")>]
[<DefaultEventAttribute("SelectedIndexChanged")>]
type DevImageComboBox =  
    class
        inherit DevComboBox
    end
```

The DevImageComboBox type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_DevCase_Controls_DevImageComboBox__ctor">DevImageComboBox</a></td><td>
Initializes a new instance of the DevImageComboBox class.</td></tr></table>&nbsp;
<a href="#devimagecombobox-class">Back to Top</a>
...
## Remarks
<a href="http://www.codeproject.com/kb/combobox/imagecombo_net.aspx" target="_blank">http://www.codeproject.com/kb/combobox/imagecombo_net.aspx</a>

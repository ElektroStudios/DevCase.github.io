# WebUtil.DownloadWebpageAsXml Method (String, WebProxy, String)
...
Dim xml As XDocument = DownloadWebpageAsXml("http://www.elhacker.net/", proxy, "Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.2; .NET CLR 1.0.3705;)")
```

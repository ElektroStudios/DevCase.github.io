...
**C#**<br />
``` C#
public struct DevModeDevices
```

**VB**<br />
``` VB
Public Structure DevModeDevices
```
...
**C++**<br />
``` C++
public value class DevModeDevices
```

**F#**<br />
``` F#
[<SealedAttribute>]
type DevModeDevices =  struct end
```

The DevModeDevices type exposes the following members.
...
<a href="#devmodedevices-structure">Back to Top</a>

# VisualStudioUtil Class
 

Contains related Visual Studio utilities.


## Inheritance Hierarchy
System.Object<br />&nbsp;&nbsp;DevCase.Interop.Managed.Tools.VisualStudioUtil<br />
...
**C#**<br />
``` C#
public sealed class VisualStudioUtil
```

**VB**<br />
``` VB
Public NotInheritable Class VisualStudioUtil
```

**VB Usage**<br />
``` VB Usage
Dim instance As VisualStudioUtil
```

**C++**<br />
``` C++
public ref class VisualStudioUtil sealed
```

**F#**<br />
``` F#
[<SealedAttribute>]
type VisualStudioUtil =  class end
```

The VisualStudioUtil type exposes the following members.
...
<a href="#visualstudioutil-class">Back to Top</a>

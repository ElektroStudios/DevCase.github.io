# WindowToWindowDocker Constructor 
 

Initializes a new instance of the <a href="T_DevCase_Core_Application_UserInterface_WindowToWindowDocker">WindowToWindowDocker</a> class.
...
Dim instance As New WindowToWindowDocker(window)
```

**C++**<br />
``` C++
public:
WindowToWindowDocker(
	IWin32Window^ window
)
```
...
``` F#
new : 
        window : IWin32Window -> WindowToWindowDocker
```

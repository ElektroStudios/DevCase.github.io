...
Contains the accumulated size and item count information retrieved by the <a href="M_DevCase_Interop_Unmanaged_Win32_NativeMethods_QueryRecycleBin">QueryRecycleBin(String, SHQueryRBInfo)</a> function.
...
**C++**<br />
``` C++
public value class SHQueryRBInfo
```

**F#**<br />
``` F#
[<SealedAttribute>]
type SHQueryRBInfo =  struct end
```

The SHQueryRBInfo type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_DevCase_Interop_Unmanaged_Win32_Structures_SHQueryRBInfo__ctor">SHQueryRBInfo</a></td><td>
Initializes a new instance of the SHQueryRBInfo structure.</td></tr></table>&nbsp;
<a href="#shqueryrbinfo-structure">Back to Top</a>
...
## Remarks
<a href="https://msdn.microsoft.com/en-us/library/windows/desktop/bb759803%28v=vs.85%29.aspx" target="_blank">https://msdn.microsoft.com/en-us/library/windows/desktop/bb759803%28v=vs.85%29.aspx</a>

# MailUtil.SendMailText Method (SmtpClient, String, String, String, String, String[], ICollection(Attachment))
...
SendMailText(DevCase.Core.NET.SmtpClients.MicrosoftLiveSmtpClient, "Username@Hotmail.com", "Password", "Email Subject", "Message Body", {"address1@domain.com", "address2@domain.com"}, attachments)
```

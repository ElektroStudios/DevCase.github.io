# DriveClient.GetOwnedItemsByName Method 
 

Gets the files and folders stored in the current user account that are owned by him and matches the specified name.
...
**C#**<br />
``` C#
public List<File> GetOwnedItemsByName(
	string displayName
)
```
...
**VB**<br />
``` VB
Public Function GetOwnedItemsByName ( 
...
returnValue = instance.GetOwnedItemsByName(displayName)
```

**C++**<br />
``` C++
public:
List<File^>^ GetOwnedItemsByName(
	String^ displayName
)
```
...
#### Parameters
&nbsp;<dl><dt>displayName</dt><dd>Type: System.String<br />\[Missing <param name="displayName"/> documentation for "M:DevCase.ThirdParty.Google.Drive.DriveClient.GetOwnedItemsByName(System.String)"\]</dd></dl>
...
Dim files As List(Of Google.Apis.Drive.v3.Data.File) = client.GetOwnedItemsByDisplayName("Item Name")

...
**C++**<br />
``` C++
public value class PrivilegeSet
```

**F#**<br />
``` F#
[<SealedAttribute>]
type PrivilegeSet =  struct end
```

The PrivilegeSet type exposes the following members.
...
<a href="#privilegeset-structure">Back to Top</a>
...
## Remarks
<a href="https://msdn.microsoft.com/en-us/library/windows/desktop/aa379307%28v=vs.85%29.aspx" target="_blank">https://msdn.microsoft.com/en-us/library/windows/desktop/aa379307%28v=vs.85%29.aspx</a>

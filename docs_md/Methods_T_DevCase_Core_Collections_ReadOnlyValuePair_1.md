# ReadOnlyValuePair(*TValue*) Methods
 

The <a href="T_DevCase_Core_Collections_ReadOnlyValuePair_1">ReadOnlyValuePair(TValue)</a> generic type exposes the following members.
...
<a href="#readonlyvaluepair(*tvalue*)-methods">Back to Top</a>

...
returnValue = sender.IsAlphanumeric()
```
...
#### Return Value
Type: Boolean<br />`true` (`True` in Visual Basic) if string is alphanumeric, `false` (`False` in Visual Basic) otherwise.

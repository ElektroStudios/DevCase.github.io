# NativeMethods.SystemParametersInfo Method (SystemParametersActionFlags, UInt32, UInt64, SystemParametersWinIniFlags)
...
&nbsp;<dl><dt>action</dt><dd>Type: <a href="T_DevCase_Interop_Unmanaged_Win32_Enums_SystemParametersActionFlags">DevCase.Interop.Unmanaged.Win32.Enums.SystemParametersActionFlags</a><br />The system-wide parameter to be retrieved or set.</dd><dt>uiParam</dt><dd>Type: System.UInt32<br />A parameter whose usage and format depends on the system parameter being queried or set. 
 ...
 For more information about system-wide parameters, see the  parameter; If not otherwise indicated, you must specify '0' for this parameter.</dd><dt>refPvParam</dt><dd>Type: System.UInt64<br />A parameter whose usage and format depends on the system parameter being queried or set. 

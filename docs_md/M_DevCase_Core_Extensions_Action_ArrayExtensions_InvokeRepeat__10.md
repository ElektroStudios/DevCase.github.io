# ArrayExtensions.InvokeRepeat(*T1*, *T2*, *T3*, *T4*, *T5*, *T6*, *T7*, *T8*, *T9*, *T10*) Method (Action(*T1*, *T2*, *T3*, *T4*, *T5*, *T6*, *T7*, *T8*, *T9*, *T10*), *T1*, *T2*, *T3*, *T4*, *T5*, *T6*, *T7*, *T8*, *T9*, *T10*, Int32)
...
public static void InvokeRepeat<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(
...
<EditorBrowsableAttribute(EditorBrowsableState.Always)>
<ExtensionAttribute>
Public Shared Sub InvokeRepeat(Of T1, T2, T3, T4, T5, T6, T7, T8, T9, T10) ( 
	action As Action(Of T1, T2, T3, T4, T5, T6, T7, T8, T9, T10),
	arg1 As T1,
	arg2 As T2,
	arg3 As T3,
	arg4 As T4,

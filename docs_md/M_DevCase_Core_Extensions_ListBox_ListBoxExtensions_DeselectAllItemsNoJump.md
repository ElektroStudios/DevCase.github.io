# ListBoxExtensions.DeselectAllItemsNoJump Method 
...
public static void DeselectAllItemsNoJump(
	this ListBox sender
)
```
...
<ExtensionAttribute>
<EditorBrowsableAttribute(EditorBrowsableState.Always)>
Public Shared Sub DeselectAllItemsNoJump ( 
	sender As ListBox
)
```
...
[ExtensionAttribute]
[EditorBrowsableAttribute(EditorBrowsableState::Always)]
static void DeselectAllItemsNoJump(
	ListBox^ sender
)
```
...
[<ExtensionAttribute>]
[<EditorBrowsableAttribute(EditorBrowsableState.Always)>]
static member DeselectAllItemsNoJump : 
        sender : ListBox -> unit 

# ControlIterator.AsyncCheck(*T*) Method (String)
 

Asynchronously Check all the Controls of the specified Type on the active Formulary.
...
returnValue = ControlIterator.AsyncCheck(containsName)
```

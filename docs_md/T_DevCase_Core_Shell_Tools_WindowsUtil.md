...
System.Object<br />&nbsp;&nbsp;<a href="T_DevCase_Core_Design_AestheticObject">DevCase.Core.Design.AestheticObject</a><br />&nbsp;&nbsp;&nbsp;&nbsp;DevCase.Core.Shell.Tools.WindowsUtil<br />
...
**C#**<br />
``` C#
public sealed class WindowsUtil : AestheticObject
```
...
**VB Usage**<br />
``` VB Usage
Dim instance As WindowsUtil
```

**C++**<br />
``` C++
public ref class WindowsUtil sealed : public AestheticObject
```
...
The WindowsUtil type exposes the following members.
...
<a href="#windowsutil-class">Back to Top</a>

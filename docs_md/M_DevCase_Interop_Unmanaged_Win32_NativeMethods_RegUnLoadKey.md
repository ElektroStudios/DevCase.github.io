# NativeMethods.RegUnLoadKey Method (RegistryHive, String)
...
returnValue = NativeMethods.RegUnLoadKey(hive, 
	subKey)
```
...
#### Parameters
&nbsp;<dl><dt>hive</dt><dd>Type: Microsoft.Win32.RegistryHive<br />The key where the subkey will be unloaded.</dd><dt>subKey</dt><dd>Type: System.String<br />The name of the subkey to be unloaded. 

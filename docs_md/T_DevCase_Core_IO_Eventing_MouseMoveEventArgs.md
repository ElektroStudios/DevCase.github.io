...
Contains the event data for the <a href="E_DevCase_Core_IO_MouseMonitor_MouseMove">MouseMove</a> event.


## Inheritance Hierarchy
System.Object<br />&nbsp;&nbsp;System.EventArgs<br />&nbsp;&nbsp;&nbsp;&nbsp;<a href="T_DevCase_Core_Design_AestheticEventArgs">DevCase.Core.Design.AestheticEventArgs</a><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;DevCase.Core.IO.Eventing.MouseMoveEventArgs<br />
...
**C#**<br />
``` C#
public sealed class MouseMoveEventArgs : AestheticEventArgs
```
...
**C++**<br />
``` C++
public ref class MouseMoveEventArgs sealed : public AestheticEventArgs
```
...
The MouseMoveEventArgs type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_DevCase_Core_IO_Eventing_MouseMoveEventArgs__ctor">MouseMoveEventArgs</a></td><td>
Initializes a new instance of the MouseMoveEventArgs class.</td></tr></table>&nbsp;
<a href="#mousemoveeventargs-class">Back to Top</a>

# ControlIterator.AsyncToggleChecked Method (Control)
 

Asynchronously Toggle the checked state of an specific ctrl.
...
returnValue = ControlIterator.AsyncToggleChecked(ctrl)
```

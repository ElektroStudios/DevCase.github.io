# NativeMethods.SendMessageTimeout Method (SafeHandle, ProgressBarMessages, IntPtr, IntPtr, SendMessageTimeoutFlags, Int32, IntPtr)
...
&nbsp;<dl><dt>hWnd</dt><dd>Type: System.Runtime.InteropServices.SafeHandle<br />A handle to the window whose window procedure will receive the message. 
 ...
 The function does not return until each window has timed out. Therefore, the total wait time can be up to the value of uTimeout multiplied by the number of top-level windows.</dd><dt>msg</dt><dd>Type: <a href="T_DevCase_Interop_Unmanaged_Win32_Enums_ProgressBarMessages">DevCase.Interop.Unmanaged.Win32.Enums.ProgressBarMessages</a><br />The message to be sent. 

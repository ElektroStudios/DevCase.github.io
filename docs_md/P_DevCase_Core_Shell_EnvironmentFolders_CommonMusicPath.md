# EnvironmentFolders.CommonMusicPath Property 
...
**VB**<br />
``` VB
Public Shared ReadOnly Property CommonMusicPath ( 
...
value = EnvironmentFolders.CommonMusicPath(folderOption)
...
``` C++
public:
static property String^ CommonMusicPath[Environment.SpecialFolderOption folderOption = Environment.SpecialFolderOption::None] {
...
**F#**<br />
``` F#
static member CommonMusicPath : string with get
...
#### Property Value
Type: String<br />\[Missing <value> documentation for "P:DevCase.Core.Shell.EnvironmentFolders.CommonMusicPath(System.Environment.SpecialFolderOption)"\]

## Examples
This is a code example. 
**VB**<br />
``` VB
Console.WriteLine($"{NameOf(EnvironmentFolders.CommonMusicPath)}={EnvironmentFolders.CommonMusicPath}")
```

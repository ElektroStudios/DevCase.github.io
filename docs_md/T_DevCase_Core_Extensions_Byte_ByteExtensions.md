...
Contains custom extension methods to use with the Byte type.


## Inheritance Hierarchy
System.Object<br />&nbsp;&nbsp;DevCase.Core.Extensions.Byte.ByteExtensions<br />
...
**VB Usage**<br />
``` VB Usage
Dim instance As ByteExtensions
```
...
[ExtensionAttribute]
[HideModuleNameAttribute]
public ref class ByteExtensions sealed
```
...
#### Reference
<a href="N_DevCase_Core_Extensions_Byte">DevCase.Core.Extensions.Byte Namespace</a><br />
# DriveClient.GetFolders Method (Func(File, Boolean))
 

Gets the folders stored in the current user account that matches the specified search criteria.
...
#### Parameters
&nbsp;<dl><dt>predicate</dt><dd>Type: System.Func(File, Boolean)<br />\[Missing <param name="predicate"/> documentation for "M:DevCase.ThirdParty.Google.Drive.DriveClient.GetFolders(System.Func{Google.Apis.Drive.v3.Data.File,System.Boolean})"\]</dd></dl>

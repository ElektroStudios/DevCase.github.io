# SoftwareUtil.BattleNet Class
 

Provides Blizzard's Battle.Net info.


## Inheritance Hierarchy
System.Object<br />&nbsp;&nbsp;<a href="T_DevCase_Core_Design_AestheticObject">DevCase.Core.Design.AestheticObject</a><br />&nbsp;&nbsp;&nbsp;&nbsp;DevCase.Core.Shell.Tools.SoftwareUtil.BattleNet<br />
...
**C#**<br />
``` C#
public sealed class BattleNet : AestheticObject
```

**VB**<br />
``` VB
Public NotInheritable Class BattleNet
	Inherits AestheticObject
```

**VB Usage**<br />
``` VB Usage
Dim instance As SoftwareUtil.BattleNet
```

**C++**<br />
``` C++
public ref class BattleNet sealed : public AestheticObject
```
...
The SoftwareUtil.BattleNet type exposes the following members.
...
<a href="#softwareutil.battlenet-class">Back to Top</a>

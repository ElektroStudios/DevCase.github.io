# ControlIterator.AsyncUncheck Method (IEnumerable(Control))
 

Asynchronously Uncheck multiple Controls at once.
...
returnValue = ControlIterator.AsyncUncheck(ctrls)
```
...
#### Parameters
&nbsp;<dl><dt>ctrls</dt><dd>Type: System.Collections.Generic.IEnumerable(Control)<br />The controls to uncheck.</dd></dl>

...
Gets a friendlly collection of all the RegEx matches being at the specified group index, and their matches positions.</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")![Static member](media/static.gif "Static member")![Code example](media/CodeExample.png "Code example")</td><td><a href="M_DevCase_Core_Text_RegEx_Tools_RegExUtil_ValidateExpression">ValidateExpression</a></td><td>
Validates the specified regular expression.</td></tr></table>&nbsp;
<a href="#regexutil-methods">Back to Top</a>

...
Represents a control that allows the user to select an hour, and to display the time with a specified format.


## Inheritance Hierarchy
System.Object<br />&nbsp;&nbsp;System.MarshalByRefObject<br />&nbsp;&nbsp;&nbsp;&nbsp;System.ComponentModel.Component<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;System.Windows.Forms.Control<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;System.Windows.Forms.DateTimePicker<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;DevCase.Controls.DevTimePicker<br />
...
public class DevTimePicker : DateTimePicker
```

**VB**<br />
``` VB
<ToolboxBitmapAttribute(GetType(DateTimePicker), "DateTimePicker.bmp")>
<ClassInterfaceAttribute(ClassInterfaceType.AutoDispatch)>
<ComVisibleAttribute(true)>
<DefaultBindingPropertyAttribute("Value")>
<DefaultEventAttribute("ValueChanged")>
<DefaultPropertyAttribute("Value")>
Public Class DevTimePicker
...
**C++**<br />
``` C++
[ToolboxBitmapAttribute(typeof(DateTimePicker), L"DateTimePicker.bmp")]
[ClassInterfaceAttribute(ClassInterfaceType::AutoDispatch)]
[ComVisibleAttribute(true)]
[DefaultBindingPropertyAttribute(L"Value")]
[DefaultEventAttribute(L"ValueChanged")]
[DefaultPropertyAttribute(L"Value")]
public ref class DevTimePicker : public DateTimePicker
```
...
The DevTimePicker type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_DevCase_Controls_DevTimePicker__ctor">DevTimePicker</a></td><td>
Initializes a new instance of the DevTimePicker class.</td></tr></table>&nbsp;
<a href="#devtimepicker-class">Back to Top</a>
